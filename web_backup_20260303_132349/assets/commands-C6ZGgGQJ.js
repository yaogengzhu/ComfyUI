const Comfy_3DViewer_Open3DViewer = { "label": "선택한 노드의 3D 뷰어(베타) 열기" };
const Comfy_BrowseModelAssets = { "label": "실험적: 모델 에셋 탐색" };
const Comfy_BrowseTemplates = { "label": "템플릿 탐색" };
const Comfy_Canvas_CopySelected = { "label": "복사" };
...
const Comfy_Canvas_PasteFromClipboard = { "label": "붙여넣기" };
const Comfy_Canvas_ResetView = { "label": "뷰 재설정" };
const Comfy_Canvas_Resize = { "label": "선택된 노드 크기 조정" };
const Comfy_Canvas_SelectAll = { "label": "모두 선택" };
...
const Comfy_MaskEditor_ColorPicker = { "label": "MaskEditor에서 색상 선택기 열기" };
const Comfy_MaskEditor_Mirror_Horizontal = { "label": "마스크 에디터에서 수평 반전" };
const Comfy_MaskEditor_Mirror_Vertical = { "label": "마스크 에디터에서 수직 반전" };
const Comfy_MaskEditor_OpenMaskEditor = { "label": "선택한 노드 마스크 편집기 열기" };
const Comfy_MaskEditor_Rotate_Left = { "label": "마스크 에디터에서 왼쪽으로 회전" };
const Comfy_MaskEditor_Rotate_Right = { "label": "마스크 에디터에서 오른쪽으로 회전" };
...
const Comfy_Queue_ToggleOverlay = { "label": "작업 기록 토글" };
const Comfy_Redo = { "label": "다시 실행" };
const Comfy_RefreshNodeDefinitions = { "label": "노드 정의 새로 고침" };
const Comfy_RenameWorkflow = { "label": "워크플로우 이름 변경" };
...
const Comfy_Subgraph_SetDescription = { "label": "서브그래프 설명 설정" };
const Comfy_Subgraph_SetSearchAliases = { "label": "서브그래프 검색 별칭 설정" };
...
const Comfy_ToggleLinear = { "label": "선형 모드 토글" };
const Comfy_ToggleQPOV2 = { "label": "Queue Panel V2 토글" };
...
//# sourceMappingURL=commands-C6ZGgGQJ.js.map
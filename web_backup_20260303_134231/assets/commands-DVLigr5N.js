...
const Comfy_Canvas_CopySelected = { "label": "Copier" };
...
const Comfy_Canvas_PasteFromClipboard = { "label": "Coller" };
...
const Comfy_Canvas_SelectAll = { "label": "Tout sélectionner" };
...
const Comfy_MaskEditor_ColorPicker = { "label": "Ouvrir le sélecteur de couleur dans MaskEditor" };
const Comfy_MaskEditor_Mirror_Horizontal = { "label": "Miroir horizontal dans MaskEditor" };
const Comfy_MaskEditor_Mirror_Vertical = { "label": "Miroir vertical dans MaskEditor" };
const Comfy_MaskEditor_OpenMaskEditor = { "label": "Ouvrir l'éditeur de masque pour le nœud sélectionné" };
const Comfy_MaskEditor_Rotate_Left = { "label": "Rotation à gauche dans MaskEditor" };
const Comfy_MaskEditor_Rotate_Right = { "label": "Rotation à droite dans MaskEditor" };
...
const Comfy_Queue_ToggleOverlay = { "label": "Afficher/masquer l'historique des tâches" };
const Comfy_Redo = { "label": "Refaire" };
const Comfy_RefreshNodeDefinitions = { "label": "Actualiser les définitions de nœud" };
const Comfy_RenameWorkflow = { "label": "Renommer le workflow" };
...
const Comfy_Subgraph_SetDescription = { "label": "Définir la description du sous-graphe" };
const Comfy_Subgraph_SetSearchAliases = { "label": "Définir les alias de recherche du sous-graphe" };
...
const Comfy_ToggleLinear = { "label": "basculer en mode linéaire" };
const Comfy_ToggleQPOV2 = { "label": "Basculer vers Queue Panel V2" };
...
//# sourceMappingURL=commands-DVLigr5N.js.map
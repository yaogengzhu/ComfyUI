...
async function handleHuizhiLogout(confirmLogout = true) {
	...
	try {
		const { useFirebaseAuthStore } = await __vitePreload(async () => {
			const { useFirebaseAuthStore } = await import("./firebaseAuthStore-D5oVUFfv.js");
...
//# sourceMappingURL=huizhiAuthService-DTHsM6kC.js.map
...
const Comfy_Canvas_CopySelected = { "label": "Копировать" };
...
const Comfy_MaskEditor_ColorPicker = { "label": "Открыть палитру цветов в MaskEditor" };
const Comfy_MaskEditor_Mirror_Horizontal = { "label": "Отразить по горизонтали в MaskEditor" };
const Comfy_MaskEditor_Mirror_Vertical = { "label": "Отразить по вертикали в MaskEditor" };
const Comfy_MaskEditor_OpenMaskEditor = { "label": "Открыть редактор масок для выбранной ноды" };
const Comfy_MaskEditor_Rotate_Left = { "label": "Повернуть влево в MaskEditor" };
const Comfy_MaskEditor_Rotate_Right = { "label": "Повернуть вправо в MaskEditor" };
...
const Comfy_Queue_ToggleOverlay = { "label": "Показать/скрыть историю заданий" };
const Comfy_Redo = { "label": "Повторить" };
const Comfy_RefreshNodeDefinitions = { "label": "Обновить определения нод" };
const Comfy_RenameWorkflow = { "label": "Переименовать рабочий процесс" };
...
const Comfy_Subgraph_SetDescription = { "label": "Установить описание подграфа" };
const Comfy_Subgraph_SetSearchAliases = { "label": "Установить поисковые псевдонимы подграфа" };
...
const Comfy_ToggleLinear = { "label": "переключить линейный режим" };
const Comfy_ToggleQPOV2 = { "label": "Переключить панель очереди V2" };
...
//# sourceMappingURL=commands-Bv_4Ubaz.js.map
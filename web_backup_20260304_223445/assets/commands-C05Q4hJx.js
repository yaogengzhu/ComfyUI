...
const Comfy_Canvas_CopySelected = { "label": "複製" };
...
const Comfy_Canvas_PasteFromClipboard = { "label": "貼上" };
const Comfy_Canvas_ResetView = { "label": "重設視圖" };
const Comfy_Canvas_Resize = { "label": "調整所選節點大小" };
const Comfy_Canvas_SelectAll = { "label": "全選" };
...
const Comfy_MaskEditor_ColorPicker = { "label": "在 MaskEditor 中開啟顏色選擇器" };
const Comfy_MaskEditor_Mirror_Horizontal = { "label": "在 MaskEditor 中水平鏡像" };
const Comfy_MaskEditor_Mirror_Vertical = { "label": "在 MaskEditor 中垂直鏡像" };
const Comfy_MaskEditor_OpenMaskEditor = { "label": "為選取的節點開啟 Mask 編輯器" };
const Comfy_MaskEditor_Rotate_Left = { "label": "在 MaskEditor 中向左旋轉" };
const Comfy_MaskEditor_Rotate_Right = { "label": "在 MaskEditor 中向右旋轉" };
...
const Comfy_ToggleLinear = { "label": "切換線性模式" };
const Comfy_ToggleQPOV2 = { "label": "切換佇列面板 V2" };
...
//# sourceMappingURL=commands-C05Q4hJx.js.map
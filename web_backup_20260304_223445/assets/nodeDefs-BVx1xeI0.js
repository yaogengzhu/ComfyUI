...
const MoonvalleyImg2VideoNode = {
	"description": "문밸리 마레이 이미지 투 비디오 노드",
	"display_name": "문밸리 마레이 이미지 투 비디오",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"image": {
			"name": "이미지",
			"tooltip": "비디오 생성에 사용되는 참조 이미지"
		},
		"negative_prompt": {
			"name": "네거티브 프롬프트",
			"tooltip": "네거티브 프롬프트 텍스트"
		},
		"prompt": { "name": "프롬프트" },
		"prompt_adherence": {
			"name": "프롬프트 준수도",
			"tooltip": "생성 제어를 위한 가이던스 스케일"
		},
		"resolution": {
			"name": "해상도",
			"tooltip": "출력 비디오의 해상도"
...
const MoonvalleyTxt2VideoNode = {
	"display_name": "문밸리 마레이 텍스트 투 비디오",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"negative_prompt": {
			"name": "네거티브 프롬프트",
...
const MoonvalleyVideo2VideoNode = {
	"display_name": "Moonvalley Marey 비디오 투 비디오",
	"inputs": {
		"control_type": { "name": "제어 유형" },
		"motion_intensity": {
			"name": "모션 강도",
			"tooltip": "'모션 전송' 제어 유형일 때만 사용됩니다"
		},
		"negative_prompt": {
			"name": "네거티브 프롬프트",
			"tooltip": "네거티브 프롬프트 텍스트"
		...
		"video": {
			"name": "비디오",
			"tooltip": "출력 비디오를 생성하는 데 사용되는 참조 비디오. 최소 5초 이상이어야 합니다. 5초보다 긴 비디오는 자동으로 잘립니다. MP4 형식만 지원됩니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
...
const PreviewAny = {
	...
	"inputs": {
		"previewMode": {},
		"preview_markdown": { "name": "미리보기" },
		"preview_text": { "name": "미리보기" },
		"source": { "name": "소스" }
	}
};
const PreviewAudio = {
...
const StabilityAudioInpaint = {
	...
	"display_name": "Stability AI 오디오 인페인팅",
	"inputs": {
		"audio": {
			"name": "오디오",
			"tooltip": "오디오 길이는 6초에서 190초 사이여야 합니다."
		},
		"control_after_generate": { "name": "생성 후 제어" },
		"duration": {
			"name": "지속 시간",
			"tooltip": "생성된 오디오의 지속 시간(초)을 제어합니다."
		},
		"mask_end": { "name": "마스크 종료" },
		"mask_start": { "name": "마스크 시작" },
		"model": { "name": "모델" },
		"prompt": { "name": "프롬프트" },
		"seed": {
			"name": "시드",
			"tooltip": "생성에 사용되는 랜덤 시드 값입니다."
		},
		"steps": {
			"name": "단계 수",
			"tooltip": "샘플링 단계 수를 제어합니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
const StabilityAudioToAudio = {
	"description": "텍스트 지침을 사용하여 기존 오디오 샘플을 새로운 고품질 구성으로 변환합니다.",
	"display_name": "Stability AI 오디오 변환",
	"inputs": {
		"audio": {
			"name": "오디오",
			"tooltip": "오디오 길이는 6초에서 190초 사이여야 합니다."
		...
		"strength": {
			"name": "강도",
			"tooltip": "이 매개변수는 오디오 매개변수가 생성된 오디오에 미치는 영향의 정도를 제어합니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
...
const StabilityTextToAudio = {
	"description": "텍스트 설명으로부터 고품질 음악과 사운드 효과를 생성합니다.",
	"display_name": "Stability AI 텍스트-오디오 변환",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"duration": {
			"name": "지속 시간",
...
//# sourceMappingURL=nodeDefs-BVx1xeI0.js.map
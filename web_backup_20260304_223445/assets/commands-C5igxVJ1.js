const Comfy_3DViewer_Open3DViewer = { "label": "Seçili Düğüm için 3D Görüntüleyiciyi Aç (Beta)" };
const Comfy_BrowseModelAssets = { "label": "Deneysel: Model Varlıklarını Gözat" };
const Comfy_BrowseTemplates = { "label": "Şablonlara Gözat" };
const Comfy_Canvas_CopySelected = { "label": "Kopyala" };
...
const Comfy_MaskEditor_ColorPicker = { "label": "MaskEditor'da Renk Seçiciyi Aç" };
const Comfy_MaskEditor_Mirror_Horizontal = { "label": "MaskEditor'da Yatay Aynala" };
const Comfy_MaskEditor_Mirror_Vertical = { "label": "MaskEditor'da Dikey Aynala" };
const Comfy_MaskEditor_OpenMaskEditor = { "label": "Seçili Düğüm için Maske Düzenleyiciyi Aç" };
const Comfy_MaskEditor_Rotate_Left = { "label": "MaskEditor'da Sola Döndür" };
const Comfy_MaskEditor_Rotate_Right = { "label": "MaskEditor'da Sağa Döndür" };
...
const Comfy_Queue_ToggleOverlay = { "label": "İş Geçmişini Göster/Gizle" };
const Comfy_Redo = { "label": "Yinele" };
const Comfy_RefreshNodeDefinitions = { "label": "Düğüm Tanımlarını Yenile" };
const Comfy_RenameWorkflow = { "label": "Çalışma Akışını Yeniden Adlandır" };
...
const Comfy_Subgraph_SetDescription = { "label": "Alt Grafik Açıklamasını Ayarla" };
const Comfy_Subgraph_SetSearchAliases = { "label": "Alt Grafik Arama Takma Adlarını Ayarla" };
...
const Comfy_ToggleLinear = { "label": "Doğrusal Modu Aç/Kapat" };
const Comfy_ToggleQPOV2 = { "label": "Kuyruk Paneli V2'yi Aç/Kapat" };
...
//# sourceMappingURL=commands-C5igxVJ1.js.map
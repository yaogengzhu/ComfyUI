const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./i18n-D81JyRUG.js","./vendor-primevue-BEjAYGWm.js","./rolldown-runtime-DLICfi3-.js","./vendor-vue-core-tg-oZu4l.js","./i18n-Ce5inB5_.js","./vendor-i18n-D6iZeZ7U.js"])))=>i.map(i=>d[i]);
...
import { $t as until, _t as useAsyncState } from "./vendor-reka-ui-C26MN8JS.js";
import { r as api } from "./api-D2HJ3Cuk.js";
import { t as useUserStore } from "./userStore-CgWi1Hiu.js";
import { r as useFirebaseAuthStore, s as useSettingStore, yi as useWorkflowStore } from "./teamWorkspaceStore-B1oHaZID.js";
const useBootstrapStore = defineStore("bootstrap", () => {
	...
	const { isReady: isI18nReady, error: i18nError, execute: loadI18n } = useAsyncState(async () => {
		const { mergeCustomNodesI18n } = await __vitePreload(async () => {
			const { mergeCustomNodesI18n } = await import("./i18n-D81JyRUG.js");
...
//# sourceMappingURL=bootstrapStore-VJu3vm3X.js.map
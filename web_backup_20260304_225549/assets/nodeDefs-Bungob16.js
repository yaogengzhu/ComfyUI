...
const KlingVideoNode = {
	...
	"inputs": {
		"control_after_generate": { "name": "contrôle après génération" },
		"generate_audio": { "name": "générer audio" },
		"model": {
			"name": "modèle",
			"tooltip": "Paramètres du modèle et de la génération."
		},
...
const MoonvalleyImg2VideoNode = {
	"description": "Nœud Moonvalley Marey Image vers Vidéo",
	"display_name": "Moonvalley Marey Image vers Vidéo",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"image": {
			"name": "image",
			"tooltip": "L'image de référence utilisée pour générer la vidéo"
		},
		"negative_prompt": {
			"name": "negative_prompt",
			"tooltip": "Texte de prompt négatif"
		},
		"prompt": { "name": "prompt" },
		"prompt_adherence": {
			"name": "prompt_adherence",
			"tooltip": "Échelle de guidage pour le contrôle de la génération"
		},
		"resolution": {
			"name": "résolution",
		...
		"seed": {
			"name": "seed",
			"tooltip": "Valeur de seed aléatoire"
		},
		"steps": {
			"name": "steps",
			"tooltip": "Nombre d'étapes de débruitage"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
const MoonvalleyTxt2VideoNode = {
	"display_name": "Moonvalley Marey Texte vers Vidéo",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"negative_prompt": {
			"name": "negative_prompt",
		...
		"steps": {
			"name": "steps",
			"tooltip": "Étapes d'inférence"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
const MoonvalleyVideo2VideoNode = {
	"display_name": "Moonvalley Marey Vidéo vers Vidéo",
	"inputs": {
		"control_type": { "name": "type_contrôle" },
		"motion_intensity": {
			"name": "intensité_mouvement",
			"tooltip": "Utilisé uniquement si le type de contrôle est 'Transfert de mouvement'"
		},
		"negative_prompt": {
			"name": "negative_prompt",
			"tooltip": "Texte de prompt négatif"
		...
		"prompt": {
			"name": "prompt",
			"tooltip": "Décrit la vidéo à générer"
		},
		"seed": {
			"name": "seed",
			"tooltip": "Valeur de seed aléatoire"
		...
		"steps": {
			"name": "étapes",
			"tooltip": "Nombre d'étapes d'inférence"
		},
		"video": {
			"name": "vidéo",
			"tooltip": "La vidéo de référence utilisée pour générer la vidéo de sortie. Doit durer au moins 5 secondes. Les vidéos plus longues que 5s seront automatiquement tronquées. Seul le format MP4 est pris en charge."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
...
//# sourceMappingURL=nodeDefs-Bungob16.js.map
...
async function handleHuizhiLogout(confirmLogout = true) {
	...
	try {
		const { useFirebaseAuthStore } = await __vitePreload(async () => {
			const { useFirebaseAuthStore } = await import("./firebaseAuthStore-_9ofnKch.js");
...
//# sourceMappingURL=huizhiAuthService-DRNED4sE.js.map
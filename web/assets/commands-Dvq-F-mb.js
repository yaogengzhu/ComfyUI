const Comfy_3DViewer_Open3DViewer = { "label": "افتح عارض ثلاثي الأبعاد (تجريبي) للعقدة المحددة" };
const Comfy_BrowseModelAssets = { "label": "تجريبي: تصفح أصول النماذج" };
const Comfy_BrowseTemplates = { "label": "تصفح القوالب" };
const Comfy_Canvas_CopySelected = { "label": "نسخ" };
...
const Comfy_MaskEditor_ColorPicker = { "label": "فتح منتقي الألوان في محرر القناع" };
const Comfy_MaskEditor_Mirror_Horizontal = { "label": "انعكاس أفقي في محرر القناع" };
const Comfy_MaskEditor_Mirror_Vertical = { "label": "انعكاس عمودي في محرر القناع" };
const Comfy_MaskEditor_OpenMaskEditor = { "label": "فتح محرر القناع للعقدة المحددة" };
const Comfy_MaskEditor_Rotate_Left = { "label": "تدوير لليسار في محرر القناع" };
const Comfy_MaskEditor_Rotate_Right = { "label": "تدوير لليمين في محرر القناع" };
...
const Comfy_Queue_ToggleOverlay = { "label": "تبديل سجل المهام" };
const Comfy_Redo = { "label": "إعادة" };
const Comfy_RefreshNodeDefinitions = { "label": "تحديث تعريفات العقد" };
const Comfy_RenameWorkflow = { "label": "إعادة تسمية سير العمل" };
...
const Comfy_Subgraph_SetDescription = { "label": "تعيين وصف الرسم البياني الفرعي" };
const Comfy_Subgraph_SetSearchAliases = { "label": "تعيين الأسماء المستعارة للبحث في الرسم البياني الفرعي" };
...
const Comfy_ToggleLinear = { "label": "تبديل الوضع الخطي" };
const Comfy_ToggleQPOV2 = { "label": "تبديل لوحة قائمة الانتظار V2" };
...
//# sourceMappingURL=commands-Dvq-F-mb.js.map
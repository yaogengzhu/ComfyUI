const Comfy_3DViewer_Open3DViewer = { "label": "为选中节点打开3D查看器（测试版）" };
const Comfy_BrowseModelAssets = { "label": "实验性：浏览模型资源" };
const Comfy_BrowseTemplates = { "label": "浏览模板" };
const Comfy_Canvas_CopySelected = { "label": "复制" };
...
const Comfy_Canvas_PasteFromClipboard = { "label": "粘贴" };
const Comfy_Canvas_ResetView = { "label": "重置视图" };
const Comfy_Canvas_Resize = { "label": "调整选定节点的大小" };
const Comfy_Canvas_SelectAll = { "label": "全选" };
...
const Comfy_MaskEditor_ColorPicker = { "label": "在MaskEditor中打开取色器" };
const Comfy_MaskEditor_Mirror_Horizontal = { "label": "在MaskEditor中水平镜像" };
const Comfy_MaskEditor_Mirror_Vertical = { "label": "在MaskEditor中垂直镜像" };
const Comfy_MaskEditor_OpenMaskEditor = { "label": "打开选中节点的遮罩编辑器" };
const Comfy_MaskEditor_Rotate_Left = { "label": "在MaskEditor中向左旋转" };
const Comfy_MaskEditor_Rotate_Right = { "label": "在MaskEditor中向右旋转" };
...
const Comfy_ToggleQPOV2 = { "label": "切换队列面板V2" };
...
//# sourceMappingURL=commands-B0u4NtS_.js.map
...
import { Di as useWorkflowStore, i as useSettingStore, ii as useFirebaseAuthStore } from "./dialogService-CwDBFHIT.js";
...
function handleHuizhiLogout(confirmLogout = true) {
	...
	try {
		const socket = window.app?.api?.socket;
		if (socket && (socket.readyState === 0 || socket.readyState === 1)) {
			socket.onclose = null;
			socket.onerror = null;
			socket.close(1e3, "User logout");
		}
	} catch (e) {}
...
//# sourceMappingURL=huizhiAuthService-BY-A9JmN.js.map
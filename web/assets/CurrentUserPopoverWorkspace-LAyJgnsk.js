...
import { B as script$2, G as script$1, J as script } from "./vendor-primevue-CN8WO3jr.js";
...
import { $r as useSubscriptionDialog, I as useSettingsDialog, Qr as useBillingContext, et as formatCreditsFromCents, i as useDialogService, ni as useCurrentUser, t as useTeamWorkspaceStore } from "./teamWorkspaceStore-CrgYR715.js";
...
import { t as useWorkspaceUI } from "./useWorkspaceUI-O_JrRU_k.js";
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", _hoisted_1, [
				...
				}, [_cache[7] || (_cache[7] = createBaseVNode("i", { class: "icon-[lucide--log-out] text-sm text-muted-foreground" }, null, -1)), createBaseVNode("span", _hoisted_15, toDisplayString(_ctx.$t("auth.signOut.signOut")), 1)])
			]);
		};
	}
});
...
//# sourceMappingURL=CurrentUserPopoverWorkspace-LAyJgnsk.js.map
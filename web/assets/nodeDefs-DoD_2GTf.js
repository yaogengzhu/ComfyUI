...
const MoonvalleyImg2VideoNode = {
	"description": "Moonvalley Marey 图像转视频节点",
	"display_name": "Moonvalley Marey 图像转视频",
	"inputs": {
		"control_after_generate": { "name": "生成后控制" },
		"image": {
			"name": "图像",
...
const MoonvalleyTxt2VideoNode = {
	"display_name": "Moonvalley Marey 文本转视频",
	"inputs": {
		"control_after_generate": { "name": "生成后控制" },
		"negative_prompt": {
			"name": "负面提示词",
...
const MoonvalleyVideo2VideoNode = {
	"display_name": "Moonvalley Marey 视频转视频",
	"inputs": {
		"control_type": { "name": "控制类型" },
		"motion_intensity": {
			"name": "运动强度",
			"tooltip": "仅在控制类型为'运动转移'时使用"
		},
		"negative_prompt": {
			"name": "负面提示词",
			"tooltip": "负面提示词文本"
		...
		"video": {
			"name": "视频",
			"tooltip": "用于生成输出视频的参考视频。必须至少5秒长。超过5秒的视频将被自动裁剪。仅支持MP4格式。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
...
const PreviewAny = {
	...
	"inputs": {
		"previewMode": {},
		"preview_markdown": { "name": "预览" },
		"preview_text": { "name": "预览" },
		"source": { "name": "源" }
	}
};
const PreviewAudio = {
...
const StabilityAudioInpaint = {
	"description": "使用文本指令转换现有音频样本的部分内容。",
	"display_name": "Stability AI 音频重绘",
	"inputs": {
		"audio": {
			"name": "音频",
			"tooltip": "音频长度必须在6到190秒之间。"
		},
		"control_after_generate": { "name": "生成后控制" },
		"duration": {
			"name": "时长",
...
const StabilityAudioToAudio = {
	"description": "使用文本指令将现有音频样本转换为新的高质量作品。",
	"display_name": "Stability AI 音频到音频",
	"inputs": {
		"audio": {
			"name": "音频",
			"tooltip": "音频长度必须在6到190秒之间。"
...
const StabilityStableImageUltraNode = {
	"description": "根据提示词和分辨率同步生成图像。",
	"display_name": "Stability AI Stable 图像 Ultra",
	"inputs": {
		"aspect_ratio": {
			"name": "宽高比",
			"tooltip": "生成图像的宽高比。"
...
const StabilityTextToAudio = {
	"description": "根据文本描述生成高质量音乐和音效。",
	"display_name": "Stability AI 文本转音频",
	"inputs": {
		"control_after_generate": { "name": "生成后控制" },
		"duration": {
			"name": "时长",
...
//# sourceMappingURL=nodeDefs-DoD_2GTf.js.map
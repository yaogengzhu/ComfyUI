...
const assetBrowser = {
	...
	"rename": { "failed": "에셋 이름을 변경할 수 없습니다." },
...
const cloudFooter_needHelp = "도움이 필요하신가요?";
const cloudForgotPassword_backToLogin = "로그인으로 돌아가기";
const cloudForgotPassword_didntReceiveEmail = "이메일을 받지 못하셨나요?";
const cloudForgotPassword_emailLabel = "이메일";
const cloudForgotPassword_emailPlaceholder = "이메일 입력";
const cloudForgotPassword_emailRequired = "이메일은 필수 항목입니다";
const cloudForgotPassword_instructions = "이메일 주소를 입력하면 비밀번호 재설정 링크를 보내드립니다.";
const cloudForgotPassword_passwordResetError = "비밀번호 재설정 이메일 전송 실패";
const cloudForgotPassword_passwordResetSent = "비밀번호 재설정 전송됨";
const cloudForgotPassword_sendResetLink = "재설정 링크 보내기";
const cloudForgotPassword_title = "비밀번호 찾기";
...
const cloudPrivateBeta_desc = "대기자 명단에 참여하려면 로그인하세요. 순서가 되면 알려드리겠습니다. 이미 알림을 받으셨나요? 로그인하여 클라우드를 사용하세요.";
const cloudPrivateBeta_title = "클라우드는 현재 프라이빗 베타 단계입니다";
const cloudSorryContactSupport_title = "죄송합니다, 지원팀에 문의하세요";
const cloudStart_desc = "설정 불필요. 모든 기기에서 작동합니다.";
const cloudStart_download = "ComfyUI 다운로드";
const cloudStart_explain = "한 번에 여러 결과물 생성. 워크플로우를 손쉽게 공유하세요.";
const cloudStart_learnAboutButton = "클라우드 알아보기";
const cloudStart_title = "몇 초 만에 제작 시작";
const cloudStart_wantToRun = "로컬에서 ComfyUI를 실행하고 싶으신가요?";
const cloudSurvey_steps_familiarity = "ComfyUI에 얼마나 익숙하신가요?";
const cloudSurvey_steps_industry = "주요 업계는 무엇인가요?";
const cloudSurvey_steps_making = "무엇을 만들 계획인가요?";
const cloudSurvey_steps_purpose = "주로 ComfyUI를 어떤 용도로 사용하실 계획인가요?";
const cloudWaitlist_contactLink = "여기";
const cloudWaitlist_questionsText = "질문이 있으신가요? 문의하기";
const color = {
	"black": "검정색",
	"blue": "파란색",
	"brown": "갈색",
...
const desktopStart = { "initialising": "초기화 중..." };
const desktopUpdate = {
...
const g = /* @__PURE__ */ JSON.parse("{\"1x\":\"1배속\",\"2x\":\"2배속\",\"about\":\"정보\",\"add\":\"추가\",\"addNode\":\"노드 추가...\",\"addNodeFilterCondition\":\"노드 필터 조건 추가\",\"all\":\"모두\",\"amount\":\"수량\",\"apply\":\"적용\",\"architecture\":\"아키텍처\",\"asset\":\"{count}개 에셋 | {count}개 에셋 | {count}개 에셋\",\"audioFailedToLoad\":\"오디오를 불러오지 못했습니다\",\"audioProgress\":\"오디오 진행률\",\"author\":\"작성자\",\"back\":\"뒤로\",\"batchRename\":\"일괄 이름 변경\",\"beta\":\"베타\",\"bookmark\":\"라이브러리에 저장\",\"calculatingDimensions\":\"크기 계산 중\",\"cancel\":\"취소\",\"cancelled\":\"취소됨\",\"capture\":\"캡처\",\"category\":\"카테고리\",\"chart\":\"차트\",\"chartLowercase\":\"차트\",\"choose_file_to_upload\":\"업로드할 파일 선택\",\"clear\":\"지우기\",\"clearAll\":\"모두 지우기\",\"clearFilters\":\"필터 지우기\",\"close\":\"닫기\",\"closeDialog\":\"대화 상자 닫기\",\"color\":\"색상\",\"comfy\":\"Comfy\",\"comfyOrgLogoAlt\":\"ComfyOrg 로고\",\"comingSoon\":\"곧 출시 예정\",\"command\":\"명령\",\"commandProhibited\":\"{command}는 금지된 명령입니다. 자세한 정보는 관리자에게 문의하십시오.\",\"community\":\"커뮤니티\",\"completed\":\"완료됨\",\"completedWithCheckmark\":\"완료됨 ✓\",\"confirm\":\"확인\",\"confirmed\":\"확인됨\",\"content\":\"콘텐츠\",\"continue\":\"계속\",\"control_after_generate\":\"생성 후 제어\",\"control_before_generate\":\"생성 전 제어\",\"copied\":\"복사됨\",\"copy\":\"복사\",\"copyAll\":\"모두 복사\",\"copyJobId\":\"작업 ID 복사\",\"copyToClipboard\":\"클립보드에 복사\",\"copyURL\":\"URL 복사\",\"core\":\"코어\",\"currentUser\":\"현재 사용자\",\"custom\":\"커스텀\",\"customBackground\":\"맞춤 배경\",\"customize\":\"사용자 정의\",\"customizeFolder\":\"폴더 사용자 정의\",\"decrement\":\"감소\",\"defaultBanner\":\"기준 배너\",\"delete\":\"삭제\",\"deleteAudioFile\":\"오디오 파일 삭제\",\"deleteImage\":\"이미지 삭제\",\"deprecated\":\"사용 중단\",\"description\":\"설명\",\"devOnly\":\"개발 전용\",\"devices\":\"장치\",\"disableAll\":\"모두 비활성화\",\"disableSelected\":\"선택 항목 비활성화\",\"disableThirdParty\":\"서드파티 비활성화\",\"disabling\":\"비활성화 중\",\"disconnectedFromBackend\":\"백엔드와의 연결이 끊어졌습니다. 서버가 실행 중인지 확인하세요.\",\"dismiss\":\"닫기\",\"download\":\"다운로드\",\"downloadAudio\":\"오디오 다운로드\",\"downloadImage\":\"이미지 다운로드\",\"downloadVideo\":\"비디오 다운로드\",\"downloadWithSize\":\"다운로드 ({size})\",\"downloading\":\"다운로드 중\",\"dropYourFileOr\":\"파일을 드롭하거나\",\"duplicate\":\"복제\",\"edit\":\"편집\",\"editImage\":\"이미지 편집\",\"editOrMaskImage\":\"이미지 편집 또는 마스크\",\"emDash\":\"—\",\"empty\":\"비어 있음\",\"enableAll\":\"모두 활성화\",\"enableOrDisablePack\":\"팩 활성화 또는 비활성화\",\"enableSelected\":\"선택 항목 활성화\",\"enabled\":\"활성화됨\",\"enabling\":\"활성화 중\",\"enter\":\"입력\",\"enterBaseName\":\"기본 이름 입력\",\"enterNewName\":\"새 이름 입력\",\"enterNewNamePrompt\":\"새 이름을 입력하세요:\",\"enterSubgraph\":\"서브그래프 진입\",\"error\":\"오류\",\"errorLoadingImage\":\"이미지 로드 오류\",\"errorLoadingVideo\":\"비디오 로드 오류\",\"essentials\":\"필수\",\"experimental\":\"베타\",\"export\":\"내보내기\",\"extensionName\":\"확장 이름\",\"extensions\":\"확장 프로그램\",\"failed\":\"실패\",\"failedToCopyJobId\":\"작업 ID 복사 실패\",\"failedToDownloadImage\":\"이미지 다운로드 실패\",\"failedToDownloadVideo\":\"비디오 다운로드 실패\",\"favorites\":\"즐겨찾기\",\"feedback\":\"피드백\",\"file\":\"파일\",\"filter\":\"필터\",\"filterBy\":\"필터 기준:\",\"filterByType\":\"{type}별로 필터링...\",\"findIssues\":\"문제 찾기\",\"frameNodes\":\"노드 프레임\",\"frontendNewer\":\"프론트엔드 버전 {frontendVersion}이(가) 백엔드 버전 {backendVersion}과(와) 호환되지 않을 수 있습니다.\",\"frontendOutdated\":\"프론트엔드 버전 {frontendVersion}이(가) 오래된 버전입니다. 백엔드는 {requiredVersion} 이상 버전이 필요합니다.\",\"galleryImage\":\"갤러리 이미지\",\"galleryThumbnail\":\"갤러리 썸네일\",\"goToNode\":\"노드로 이동\",\"graphNavigation\":\"그래프 탐색\",\"halfSpeed\":\"0.5배속\",\"hideLeftPanel\":\"왼쪽 패널 숨기기\",\"hideRightPanel\":\"오른쪽 패널 숨기기\",\"icon\":\"아이콘\",\"imageDoesNotExist\":\"이미지가 존재하지 않습니다\",\"imageFailedToLoad\":\"이미지를 로드하지 못했습니다.\",\"imagePreview\":\"이미지 미리보기 - 화살표 키를 사용하여 이미지 간 이동\",\"imageUrl\":\"이미지 URL\",\"import\":\"가져오기\",\"inProgress\":\"진행 중\",\"inSubgraph\":\"서브그래프 '{name}'에 있음\",\"increment\":\"증가\",\"info\":\"노드 정보\",\"input\":\"입력\",\"insert\":\"삽입\",\"install\":\"설치\",\"installed\":\"설치됨\",\"installing\":\"설치 중\",\"interrupted\":\"중단됨\",\"itemSelected\":\"{selectedCount}개 선택됨\",\"itemsCopiedToClipboard\":\"항목이 클립보드에 복사되었습니다\",\"itemsSelected\":\"{selectedCount}개 선택됨\",\"job\":\"작업\",\"jobIdCopied\":\"작업 ID가 클립보드에 복사됨\",\"keybinding\":\"키 바인딩\",\"keybindingAlreadyExists\":\"단축키가 이미 존재합니다\",\"keybindings\":\"단축키\",\"learnMore\":\"더 알아보기\",\"listening\":\"듣는 중...\",\"liveSamplingPreview\":\"라이브 샘플링 미리보기\",\"loadAllFolders\":\"모든 폴더 로드\",\"loadWorkflow\":\"워크플로 로드\",\"loading\":\"로딩 중\",\"loadingPanel\":\"{panel} 패널 불러오는 중...\",\"login\":\"로그인\",\"logoAlt\":\"ComfyUI 로고\",\"logs\":\"로그\",\"manageExtensions\":\"확장 프로그램 관리\",\"markdown\":\"마크다운\",\"micPermissionDenied\":\"마이크 권한이 거부되었습니다\",\"migrate\":\"이전(migrate)\",\"missing\":\"누락됨\",\"more\":\"더보기\",\"moreOptions\":\"추가 옵션\",\"moreWorkflows\":\"더 많은 워크플로\",\"mostRelevant\":\"가장 관련성 높은\",\"multiSelectDropdown\":\"다중 선택 드롭다운\",\"name\":\"이름\",\"newFolder\":\"새 폴더\",\"next\":\"다음\",\"nightly\":\"NIGHTLY\",\"no\":\"아니오\",\"noAudioRecorded\":\"녹음된 오디오가 없습니다\",\"noItems\":\"항목 없음\",\"noResults\":\"결과 없음\",\"noResultsFound\":\"결과를 찾을 수 없습니다.\",\"noTasksFound\":\"작업을 찾을 수 없습니다.\",\"noTasksFoundMessage\":\"대기열에 작업이 없습니다.\",\"noWorkflowsFound\":\"워크플로를 찾을 수 없습니다.\",\"nodeContentError\":\"노드 콘텐츠 오류\",\"nodeHeaderError\":\"노드 헤더 오류\",\"nodeRenderError\":\"노드 렌더링 오류\",\"nodeSlotsError\":\"노드 슬롯 오류\",\"nodeWidgetsError\":\"노드 위젯 오류\",\"nodes\":\"노드\",\"nodesCount\":\"{count}개 노드 | {count}개 노드 | {count}개 노드\",\"nodesRunning\":\"노드 실행 중\",\"none\":\"없음\",\"nothingToCopy\":\"복사할 항목 없음\",\"nothingToDelete\":\"삭제할 항목 없음\",\"nothingToDuplicate\":\"복제할 항목 없음\",\"nothingToRename\":\"이름을 변경할 항목 없음\",\"ok\":\"확인\",\"openManager\":\"관리자 열기\",\"openNewIssue\":\"새 문제 열기\",\"or\":\"또는\",\"output\":\"출력\",\"overwrite\":\"덮어쓰기\",\"playPause\":\"재생/일시정지\",\"playRecording\":\"녹음 재생\",\"playbackSpeed\":\"재생 속도\",\"playing\":\"재생 중\",\"pressKeysForNewBinding\":\"새 바인딩을 위한 키 입력\",\"preview\":\"미리보기\",\"profile\":\"프로필\",\"progressCountOf\":\"중\",\"queued\":\"대기 중\",\"ready\":\"준비됨\",\"reconnected\":\"재연결됨\",\"reconnecting\":\"재연결 중\",\"refresh\":\"새로 고침\",\"refreshNode\":\"노드 새로고침\",\"relativeTime\":{\"daysAgo\":\"{count}일 전\",\"hoursAgo\":\"{count}시간 전\",\"minutesAgo\":\"{count}분 전\",\"monthsAgo\":\"{count}개월 전\",\"now\":\"지금\",\"weeksAgo\":\"{count}주 전\",\"yearsAgo\":\"{count}년 전\"},\"releaseTitle\":\"{package} {version} 릴리스\",\"reloadToApplyChanges\":\"변경 사항을 적용하려면 새로 고침하세요.\",\"remove\":\"제거\",\"removeImage\":\"이미지 제거\",\"removeTag\":\"태그 제거\",\"removeVideo\":\"비디오 제거\",\"rename\":\"이름 바꾸기\",\"reportIssue\":\"보고서 보내기\",\"reportIssueTooltip\":\"Comfy Org에 오류 보고서를 제출합니다.\",\"reportSent\":\"보고서 제출됨\",\"reset\":\"재설정\",\"resetAll\":\"모두 초기화\",\"resetAllKeybindingsTooltip\":\"모든 키 바인딩을 기본값으로 초기화\",\"resizeFromBottomLeft\":\"왼쪽 아래 모서리에서 크기 조정\",\"resizeFromBottomRight\":\"오른쪽 아래 모서리에서 크기 조정\",\"resizeFromTopLeft\":\"왼쪽 위 모서리에서 크기 조정\",\"resizeFromTopRight\":\"오른쪽 위 모서리에서 크기 조정\",\"restart\":\"재시작\",\"resultsCount\":\"{count} 개의 결과를 찾았습니다\",\"running\":\"실행 중\",\"save\":\"저장\",\"saving\":\"저장 중\",\"scrollLeft\":\"왼쪽으로 스크롤\",\"scrollRight\":\"오른쪽으로 스크롤\",\"search\":\"검색\",\"searchExtensions\":\"확장 검색\",\"searchFailedMessage\":\"검색어와 일치하는 설정을 찾을 수 없습니다. 검색어를 조정해 보세요.\",\"searchKeybindings\":\"키 바인딩 검색\",\"searchModels\":\"모델 검색\",\"searchNodes\":\"노드 검색\",\"searchPlaceholder\":\"검색...\",\"searchSettings\":\"설정 검색\",\"searchWorkflows\":\"워크플로 검색\",\"seeTutorial\":\"튜토리얼 보기\",\"selectItemsToCopy\":\"복사할 항목 선택\",\"selectItemsToDelete\":\"삭제할 항목 선택\",\"selectItemsToDuplicate\":\"복제할 항목 선택\",\"selectItemsToRename\":\"이름을 변경할 항목 선택\",\"selectedFile\":\"선택된 파일\",\"setAsBackground\":\"배경으로 설정\",\"settings\":\"설정\",\"shortcutSuffix\":\" ({shortcut})\",\"showLeftPanel\":\"왼쪽 패널 표시\",\"showReport\":\"보고서 보기\",\"showRightPanel\":\"오른쪽 패널 표시\",\"singleSelectDropdown\":\"단일 선택 드롭다운\",\"sort\":\"정렬\",\"source\":\"소스\",\"startRecording\":\"녹음 시작\",\"status\":\"상태\",\"stopPlayback\":\"재생 중지\",\"stopRecording\":\"녹음 중지\",\"submit\":\"제출\",\"success\":\"성공\",\"systemInfo\":\"시스템 정보\",\"terminal\":\"터미널\",\"title\":\"제목\",\"triggerPhrase\":\"트리거 문구\",\"unknownError\":\"알 수 없는 오류\",\"unknownFile\":\"알 수 없는 파일\",\"untitled\":\"제목 없음\",\"update\":\"업데이트\",\"updateAvailable\":\"업데이트 가능\",\"updateFrontend\":\"프론트엔드 업데이트\",\"updated\":\"업데이트 됨\",\"updating\":\"업데이트 중\",\"upload\":\"업로드\",\"uploadAlreadyInProgress\":\"업로드가 이미 진행 중입니다\",\"usageHint\":\"사용 힌트\",\"use\":\"사용\",\"user\":\"사용자\",\"versionMismatchWarning\":\"버전 호환성 경고\",\"versionMismatchWarningMessage\":\"{warning}: {detail} 업데이트 지침은 https://docs.comfy.org/installation/update_comfyui#common-update-issues 를 방문하세요.\",\"videoFailedToLoad\":\"비디오를 로드하지 못했습니다.\",\"videoPreview\":\"비디오 미리보기 - 화살표 키를 사용하여 비디오 간 이동\",\"viewImageOfTotal\":\"이미지 {index}/{total} 보기\",\"viewVideoOfTotal\":\"비디오 {index}/{total} 보기\",\"volume\":\"볼륨\",\"warning\":\"경고\",\"workflow\":\"워크플로\",\"you\":\"당신\"}");
...
const issueReport = { "helpFix": "이 문제 해결에 도움을 주세요" };
const linearMode = {
	"appModeToolbar": {
		"appBuilder": "앱 빌더",
		"apps": "앱"
...
const rightSidePanel = {
	...
	"pinned": "고정됨",
	"promptErrors": {
		"no_prompt": { "desc": "서버로 전송된 워크플로우 데이터가 비어 있습니다. 이는 예기치 않은 시스템 오류일 수 있습니다." },
		"prompt_no_outputs": { "desc": "워크플로우에 결과를 생성할 출력 노드(예: 이미지 저장, 이미지 미리보기)가 포함되어 있지 않습니다." },
		"server_error_cloud": { "desc": "서버에서 예기치 않은 오류가 발생했습니다. 나중에 다시 시도해 주세요." },
		"server_error_local": { "desc": "서버에서 예기치 않은 오류가 발생했습니다. 서버 로그를 확인해 주세요." }
	},
	"properties": "속성",
...
const subscription = {
	...
	"freeTier": {
		...
		"topUpBlocked": { "title": "충전 및 추가 혜택 잠금 해제" },
		"upgradeCta": "플랜 보기"
	},
...
const templateWidgets = { "sort": { "searchPlaceholder": "검색..." } };
...
const vueNodesMigrationMainMenu = { "message": "메인 메뉴에서 언제든지 Nodes 2.0으로 다시 전환할 수 있습니다." };
const vueNodesSlot = { "iterative": "(반복)" };
const welcome = {
	"getStarted": "시작하기",
...
//# sourceMappingURL=main-D6ntfRCO.js.map
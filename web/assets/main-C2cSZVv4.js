...
const cloudFooter_needHelp = "需要帮助？";
const cloudForgotPassword_backToLogin = "返回登录";
const cloudForgotPassword_didntReceiveEmail = "没有收到邮件？";
const cloudForgotPassword_emailLabel = "电子邮件";
const cloudForgotPassword_emailPlaceholder = "输入您的邮箱";
const cloudForgotPassword_emailRequired = "邮箱是必填项";
const cloudForgotPassword_instructions = "请输入您的电子邮件地址，我们将向您发送重置密码的链接。";
const cloudForgotPassword_passwordResetError = "发送密码重置邮件失败";
const cloudForgotPassword_passwordResetSent = "密码重置邮件已发送";
const cloudForgotPassword_sendResetLink = "发送重置链接";
const cloudForgotPassword_title = "忘记密码";
...
const cloudPrivateBeta_desc = "登录以加入等候名单。轮到您时我们会通知您。已经收到通知？登录开始使用 Cloud。";
const cloudPrivateBeta_title = "云服务目前处于内测阶段";
const cloudSorryContactSupport_title = "抱歉，请联系客服";
const cloudStart_desc = "无需任何设置。可在任何设备上使用。";
const cloudStart_download = "下载 ComfyUI";
const cloudStart_explain = "一次性生成多个输出。轻松分享工作流。";
const cloudStart_learnAboutButton = "了解云服务";
const cloudStart_title = "几秒钟内开始创作";
const cloudStart_wantToRun = "想在本地运行 ComfyUI 吗？";
const cloudSurvey_steps_familiarity = "你对 ComfyUI 有多熟悉？";
const cloudSurvey_steps_industry = "您的主要行业是什么？";
const cloudSurvey_steps_making = "你打算做什么？";
const cloudSurvey_steps_purpose = "您将主要使用 ComfyUI 做什么？";
const cloudWaitlist_contactLink = "这里";
const cloudWaitlist_questionsText = "有问题？联系我们";
const color = {
	"black": "黑色",
	"blue": "蓝色",
	"brown": "棕色",
...
const desktopStart = { "initialising": "正在初始化..." };
const desktopUpdate = {
...
const g = {
	...
	"disableThirdParty": "禁用第三方",
	"disabling": "禁用中",
	"disconnectedFromBackend": "已与后端断开连接。请检查服务器是否正在运行。",
	"dismiss": "关闭",
	"download": "下载",
	"downloadAudio": "下载音频",
	"downloadImage": "下载图片",
	...
	"itemsCopiedToClipboard": "已复制到剪贴板",
	...
	"nodeContentError": "节点内容错误",
	"nodeHeaderError": "节点标题错误",
	"nodeRenderError": "节点渲染错误",
	"nodeSlotsError": "节点插槽错误",
	"nodeWidgetsError": "节点控件错误",
	"nodes": "节点",
	"nodesCount": "{count} 个节点",
	"nodesRunning": "节点正在运行",
	"none": "无",
	"nothingToCopy": "没有可以复制的内容",
	"nothingToDelete": "没有可以删除的内容",
	"nothingToDuplicate": "Nothing to duplicate",
	"nothingToRename": "没有可以重命名的内容",
	"ok": "确定",
	"openManager": "打开管理器",
	"openNewIssue": "打开新问题",
	"or": "或",
	...
	"seeTutorial": "查看教程",
	"selectItemsToCopy": "选择复制",
	"selectItemsToDelete": "选择删除",
	...
	"videoPreview": "视频预览 - 使用方向键切换视频",
	"viewImageOfTotal": "查看第 {index} 张图片，共 {total} 张",
	"viewVideoOfTotal": "查看第 {index} 个视频，共 {total} 个",
	"volume": "音量",
	"warning": "警告",
	"workflow": "工作流",
	"you": "你"
...
const issueReport = { "helpFix": "帮助修复这个" };
const linearMode = {
	"appModeToolbar": {
		"appBuilder": "应用构建器",
		"apps": "应用"
	...
	"arrange": {
		...
		"switchToSelect": "切换到“选择”步骤，点击输出节点将其添加到此处。",
...
const rightSidePanel = {
	...
	"pinned": "顶固",
	"promptErrors": {
		"no_prompt": { "desc": "发送到服务器的工作流数据为空。这可能是一个意外的系统错误。" },
		"prompt_no_outputs": { "desc": "工作流中没有包含任何输出节点（例如：保存图像、预览图像），无法生成结果。" },
		"server_error_cloud": { "desc": "服务器遇到意外错误。请稍后再试。" },
		"server_error_local": { "desc": "服务器遇到意外错误。请检查服务器日志。" }
	},
	"properties": "属性",
	"removeFavorite": "取消收藏",
...
const subscription = {
	...
	"beta": "测试版",
	"billedMonthly": "每月付款",
	"billedYearly": "{total} 每年付款",
	"billingComingSoon": {
		"message": "团队计费功能即将上线。您将可以为您的工作区按成员数订阅套餐。敬请关注后续更新。",
		"title": "即将推出"
	},
	"cancelDialog": {
		"confirmCancel": "取消订阅",
		"description": "您的访问权限将持续到 {date}。您将不再被扣费，您的工作区和积分将被保留。您可以随时重新订阅。",
		"endOfBillingPeriod": "账单周期结束",
		"failed": "取消订阅失败",
	...
	"contactUs": "联系我们",
	"creditsRemainingThisMonth": "本月剩余积分",
	"creditsRemainingThisYear": "今年剩余积分",
	"creditsYouveAdded": "你获得的积分",
	"currentPlan": "当前订阅计划",
	...
	"freeTier": {
		...
		"subscribeCta": "订阅获取更多",
		"title": "您正在使用免费套餐",
		"topUpBlocked": { "title": "解锁补充积分和更多功能" },
		"upgradeCta": "查看套餐"
	},
	...
	"monthlyCreditsRollover": "这些积分将结转到下个月",
	"mostPopular": "最受欢迎",
	...
	"prepaidDescription": "预付款额度",
	"preview": {
		"addCreditCard": "添加信用卡",
		"backToAllPlans": "返回所有方案",
		"confirm": "确认",
		"confirmPayment": "确认付款",
		...
		"perMember": "/ 每成员",
		"privacyPolicy": "隐私政策",
		"proratedCharge": "{plan} 按比例收费",
		"proratedRefund": "{plan} 按比例退款",
	...
	"required": {
		...
		"pollingTimeout": "等待订阅超时。请刷新并重试。",
		"subscribe": "订阅",
		"title": "订阅",
		"waitingForSubscription": "请在新标签页中完成订阅。我们会自动检测到您已完成！"
	},
	"resubscribe": "重新订阅",
	...
	"subscribeNow": "立即订阅",
	"subscribeTo": "订阅 {plan}",
	"subscribeToComfyCloud": "订阅 Comfy Cloud",
	"subscribeToRun": "订阅",
	...
	"title": "订阅",
	"titleUnsubscribed": "订阅 Comfy Cloud",
	"totalCredits": "总积分",
	"upgrade": "升级",
	"upgradePlan": "升级订阅",
	"upgradeTo": "升级到 {plan}",
	...
	"videoEstimateTryTemplate": "试试 Wan Fun Control template →",
	"videoTemplateBasedCredits": "使用 Wan 2.2 图像转视频生成的视频",
	"viewEnterprise": "查看企业",
...
const templateWidgets = { "sort": { "searchPlaceholder": "搜索中..." } };
...
const templates = { "logoProviderSeparator": " 与 " };
const toastMessages = {
...
const vueNodesMigrationMainMenu = { "message": "在主菜单中随时切换回 Nodes 2.0" };
const vueNodesSlot = { "iterative": "（迭代）" };
const welcome = {
	"getStarted": "开始使用",
	"title": "欢迎使用 ComfyUI"
};
...
const workspacePanel = {
	...
	"inviteMemberDialog": {
		...
		"linkStep": {
			"copyLink": "复制链接",
			"done": "完成",
			"message": "请确保其账号使用的是该邮箱。",
			"title": "将此链接发送给对方"
		},
		"message": "创建一个可分享的邀请链接发送给他人",
		"placeholder": "输入对方邮箱",
		"title": "邀请他人加入此工作区"
	},
	"inviteUpsellDialog": {
	...
	"members": {
		...
		"personalWorkspaceMessage": "您目前无法邀请其他成员加入您的个人工作区。如需添加成员，请",
		"tabs": {
			"active": "已激活",
			"pendingCount": "待处理（{count}）"
		},
		"upsellBannerSubscribe": "订阅 Creator 及以上套餐以邀请团队成员加入此工作区。",
		"upsellBannerUpgrade": "升级到 Creator 及以上套餐以邀请更多团队成员。",
		"viewPlans": "查看套餐"
	},
	"menu": {
...
//# sourceMappingURL=main-C2cSZVv4.js.map
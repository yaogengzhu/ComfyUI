const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./i18n-NzSphxo3.js","./vendor-primevue-DxYsW_Ng.js","./rolldown-runtime-DLICfi3-.js","./vendor-vue-core-tg-oZu4l.js","./i18n-Dw0liyWq.js","./vendor-i18n-czJbbAfl.js"])))=>i.map(i=>d[i]);
...
import { r as api } from "./api-CZwqvkO0.js";
import { Di as useWorkflowStore, i as useSettingStore, ii as useFirebaseAuthStore } from "./dialogService-B--1tJQn.js";
...
const useBootstrapStore = defineStore("bootstrap", () => {
	...
	const { isReady: isI18nReady, error: i18nError, execute: loadI18n } = useAsyncState(async () => {
		const { mergeCustomNodesI18n } = await __vitePreload(async () => {
			const { mergeCustomNodesI18n } = await import("./i18n-NzSphxo3.js");
...
function handleHuizhiLogout(confirmLogout = true) {
	...
	try {
		...
		overlay.style.cssText = "position:fixed;top:0;left:0;right:0;bottom:0;background:#1a1a1a;z-index:999999;display:flex;align-items:center;justify-content:center;color:#fff;font-size:18px;";
	...
	const highestIntervalId = setInterval(() => {}, 1e4);
	...
	const closeWebSocket = (socket, name) => {
		...
		try {
			...
			if (socket.readyState === WebSocket.CONNECTING || socket.readyState === WebSocket.OPEN) socket.close(1e3, "User logout");
		} catch (e) {
			console.warn("[HuizhiAuth] Error closing WebSocket:", name, e);
		}
	};
	if (window.app?.api?.socket) {
...
//# sourceMappingURL=huizhiAuthService-B-OeUzbx.js.map
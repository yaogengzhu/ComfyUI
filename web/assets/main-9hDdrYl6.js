...
const assetBrowser = {
	...
	"assetCollection": "Collection d'actifs",
	"assets": "Ressources",
	...
	"civitaiLinkLabel": "Lien {download} du modèle Civitai",
	"civitaiLinkLabelDownload": "télécharger",
	"civitaiLinkPlaceholder": "Collez le lien ici",
	"confirmModelDetails": "Confirmer les détails du modèle",
	"connectionError": "Veuillez vérifier votre connexion et réessayer",
	"deletion": {
		"body": "Ce modèle sera définitivement supprimé de votre bibliothèque.",
		"complete": "{assetName} a été supprimé.",
		"failed": "{assetName} n'a pas pu être supprimé.",
		"header": "Supprimer ce modèle ?",
		"inProgress": "Suppression de {assetName}..."
	},
	"download": {
	...
	"emptyImported": {
		"canImport": "Aucun modèle importé pour le moment. Cliquez sur «\xA0Importer un modèle\xA0» pour ajouter le vôtre.",
	...
	"modelTypeSelectorPlaceholder": "Sélectionnez le type de modèle",
	...
	"noResultsCanImport": "Essayez d’ajuster votre recherche ou vos filtres.\nVous pouvez également ajouter des modèles en utilisant le bouton «\xA0Importer\xA0» ci-dessus.",
	...
	"ownership": "Propriété",
	"ownershipAll": "Tous",
	"ownershipMyModels": "Mes modèles",
	"ownershipPublicModels": "Modèles publics",
	"processingModel": "Téléchargement démarré",
	"processingModelDescription": "Vous pouvez fermer cette fenêtre. Le téléchargement continuera en arrière-plan.",
	"providerCivitai": "Civitai",
	"providerHuggingFace": "Hugging Face",
	"rename": { "failed": "Impossible de renommer l'actif." },
	"selectFrameworks": "Sélectionner les frameworks",
	"selectModelType": "Sélectionner le type de modèle",
	"selectProjects": "Sélectionner les projets",
	"sortAZ": "A-Z",
	"sortBy": "Trier par",
	...
	"tagsPlaceholder": "ex. : modèles, checkpoint",
	"tryAdjustingFilters": "Essayez d'ajuster votre recherche ou vos filtres",
	"unknown": "Inconnu",
	"unsupportedUrlSource": "Seules les URL provenant de {sources} sont prises en charge",
	"upgradeFeatureDescription": "Cette fonctionnalité est disponible uniquement avec les abonnements Creator ou Pro.",
	"upgradeToUnlockFeature": "Passez à la version supérieure pour débloquer cette fonctionnalité",
	"upload": "Importer",
	"uploadFailed": "Échec de l'importation",
	"uploadModel": "Importer",
	"uploadModelDescription1": "Collez un lien de téléchargement de modèle Civitai pour l'ajouter à votre bibliothèque.",
	"uploadModelDescription1Generic": "Collez un lien de téléchargement de modèle pour l'ajouter à votre bibliothèque.",
	"uploadModelDescription2": "Seuls les liens provenant de {link} sont actuellement pris en charge",
	"uploadModelDescription2Generic": "Seules les URL des fournisseurs suivants sont prises en charge :",
	"uploadModelDescription2Link": "https://civitai.com/models",
	"uploadModelDescription3": "Taille maximale du fichier : {size}",
	"uploadModelFailedToRetrieveMetadata": "Impossible de récupérer les métadonnées. Veuillez vérifier le lien et réessayer.",
	"uploadModelFromCivitai": "Importer un modèle depuis Civitai",
	"uploadModelGeneric": "Importer un modèle",
	"uploadModelHelpFooterText": "Besoin d'aide pour trouver les URL ? Cliquez sur un fournisseur ci-dessous pour voir une vidéo explicative.",
	"uploadModelHelpVideo": "Vidéo d'aide à l'importation de modèle",
	"uploadModelHowDoIFindThis": "Comment trouver ceci ?",
	"uploadSuccess": "Modèle importé avec succès !",
	"uploadingModel": "Importation du modèle..."
};
const auth = {
	"apiKey": {
...
const cloudFooter_needHelp = "Besoin d'aide ?";
const cloudForgotPassword_backToLogin = "Retour à la connexion";
const cloudForgotPassword_didntReceiveEmail = "Vous n'avez pas reçu d'e-mail ?";
const cloudForgotPassword_emailLabel = "E-mail";
const cloudForgotPassword_emailPlaceholder = "Entrez votre e-mail";
const cloudForgotPassword_emailRequired = "L'e-mail est requis";
const cloudForgotPassword_instructions = "Entrez votre adresse e-mail et nous vous enverrons un lien pour réinitialiser votre mot de passe.";
const cloudForgotPassword_passwordResetError = "Échec de l'envoi de l'e-mail de réinitialisation du mot de passe";
const cloudForgotPassword_passwordResetSent = "Réinitialisation du mot de passe envoyée";
const cloudForgotPassword_sendResetLink = "Envoyer le lien de réinitialisation";
const cloudForgotPassword_title = "Mot de passe oublié";
...
const cloudPrivateBeta_desc = "Connectez-vous pour rejoindre la liste d'attente. Nous vous préviendrons quand ce sera votre tour. Déjà notifié ? Connectez-vous pour commencer à utiliser Cloud.";
const cloudPrivateBeta_title = "Cloud est actuellement en bêta privée";
const cloudSorryContactSupport_title = "Désolé, contactez le support";
const cloudStart_desc = "Aucune configuration requise. Fonctionne sur tous les appareils.";
const cloudStart_download = "Télécharger ComfyUI";
const cloudStart_explain = "Générez plusieurs résultats à la fois. Partagez facilement vos flux de travail.";
const cloudStart_learnAboutButton = "En savoir plus sur Cloud";
const cloudStart_title = "créez en quelques secondes";
const cloudStart_wantToRun = "Vous préférez exécuter ComfyUI localement ?";
const cloudSurvey_steps_familiarity = "Quelle est votre familiarité avec ComfyUI ?";
const cloudSurvey_steps_industry = "Quel est votre secteur d'activité principal ?";
const cloudSurvey_steps_making = "Que prévoyez-vous de créer ?";
const cloudSurvey_steps_purpose = "À quoi utiliserez-vous principalement ComfyUI ?";
const cloudWaitlist_contactLink = "ici";
const cloudWaitlist_questionsText = "Des questions ? Contactez-nous";
const color = {
	"black": "Noir",
	"blue": "Bleu",
	"brown": "Marron",
...
const desktopStart = { "initialising": "Initialisation..." };
const desktopUpdate = {
...
const g = /* @__PURE__ */ JSON.parse("{\"1x\":\"1x\",\"2x\":\"2x\",\"about\":\"À propos\",\"add\":\"Ajouter\",\"addNode\":\"Ajouter un nœud...\",\"addNodeFilterCondition\":\"Ajouter une condition de filtre de nœud\",\"all\":\"Tout\",\"amount\":\"Quantité\",\"apply\":\"Appliquer\",\"architecture\":\"Architecture\",\"asset\":\"{count} ressources | {count} ressource | {count} ressources\",\"audioFailedToLoad\":\"Échec du chargement de l'audio\",\"audioProgress\":\"Progression audio\",\"author\":\"Auteur\",\"back\":\"Retour\",\"batchRename\":\"Renommer en lot\",\"beta\":\"BÊTA\",\"bookmark\":\"Enregistrer dans la bibliothèque\",\"calculatingDimensions\":\"Calcul des dimensions\",\"cancel\":\"Annuler\",\"cancelled\":\"Annulé\",\"capture\":\"capture\",\"category\":\"Catégorie\",\"chart\":\"Graphique\",\"chartLowercase\":\"graphique\",\"choose_file_to_upload\":\"choisissez le fichier à télécharger\",\"clear\":\"Effacer\",\"clearAll\":\"Tout effacer\",\"clearFilters\":\"Effacer les filtres\",\"close\":\"Fermer\",\"closeDialog\":\"Fermer la boîte de dialogue\",\"color\":\"Couleur\",\"comfy\":\"Comfy\",\"comfyOrgLogoAlt\":\"Logo ComfyOrg\",\"comingSoon\":\"Bientôt disponible\",\"command\":\"Commande\",\"commandProhibited\":\"La commande {command} est interdite. Contactez un administrateur pour plus d'informations.\",\"community\":\"Communauté\",\"completed\":\"Terminé\",\"completedWithCheckmark\":\"Terminé ✓\",\"confirm\":\"Confirmer\",\"confirmed\":\"Confirmé\",\"content\":\"contenu\",\"continue\":\"Continuer\",\"control_after_generate\":\"contrôle après génération\",\"control_before_generate\":\"contrôle avant génération\",\"copied\":\"Copié\",\"copy\":\"Copier\",\"copyAll\":\"Tout copier\",\"copyJobId\":\"Copier l'ID du travail\",\"copyToClipboard\":\"Copier dans le presse-papiers\",\"copyURL\":\"Copier l’URL\",\"core\":\"Noyau\",\"currentUser\":\"Utilisateur actuel\",\"custom\":\"Personnalisé\",\"customBackground\":\"Arrière-plan personnalisé\",\"customize\":\"Personnaliser\",\"customizeFolder\":\"Personnaliser le dossier\",\"decrement\":\"Diminuer\",\"defaultBanner\":\"bannière par défaut\",\"delete\":\"Supprimer\",\"deleteAudioFile\":\"Supprimer le fichier audio\",\"deleteImage\":\"Supprimer l'image\",\"deprecated\":\"DEPR\",\"description\":\"Description\",\"devOnly\":\"DEV\",\"devices\":\"Appareils\",\"disableAll\":\"Désactiver tout\",\"disableSelected\":\"Désactiver la sélection\",\"disableThirdParty\":\"Désactiver les tiers\",\"disabling\":\"Désactivation\",\"disconnectedFromBackend\":\"Déconnecté du backend. Vérifiez si le serveur est en cours d’exécution.\",\"dismiss\":\"Fermer\",\"download\":\"Télécharger\",\"downloadAudio\":\"Télécharger l'audio\",\"downloadImage\":\"Télécharger l'image\",\"downloadVideo\":\"Télécharger la vidéo\",\"downloadWithSize\":\"Télécharger ({size})\",\"downloading\":\"Téléchargement\",\"dropYourFileOr\":\"Déposez votre fichier ou\",\"duplicate\":\"Dupliquer\",\"edit\":\"Modifier\",\"editImage\":\"Modifier l'image\",\"editOrMaskImage\":\"Modifier ou masquer l'image\",\"emDash\":\"—\",\"empty\":\"Vide\",\"enableAll\":\"Activer tout\",\"enableOrDisablePack\":\"Activer ou désactiver le pack\",\"enableSelected\":\"Activer la sélection\",\"enabled\":\"Activé\",\"enabling\":\"Activation\",\"enter\":\"Entrer\",\"enterBaseName\":\"Entrez le nom de base\",\"enterNewName\":\"Entrez le nouveau nom\",\"enterNewNamePrompt\":\"Entrez le nouveau nom :\",\"enterSubgraph\":\"Entrer dans le sous-graphe\",\"error\":\"Erreur\",\"errorLoadingImage\":\"Erreur lors du chargement de l'image\",\"errorLoadingVideo\":\"Erreur lors du chargement de la vidéo\",\"essentials\":\"Essentiels\",\"experimental\":\"BETA\",\"export\":\"Exportation\",\"extensionName\":\"Nom de l'extension\",\"extensions\":\"Extensions\",\"failed\":\"Échec\",\"failedToCopyJobId\":\"Échec de la copie de l'ID du travail\",\"failedToDownloadImage\":\"Échec du téléchargement de l'image\",\"failedToDownloadVideo\":\"Échec du téléchargement de la vidéo\",\"favorites\":\"Favoris\",\"feedback\":\"Commentaires\",\"file\":\"fichier\",\"filter\":\"Filtrer\",\"filterBy\":\"Filtrer par :\",\"filterByType\":\"Filtrer par {type}...\",\"findIssues\":\"Trouver des problèmes\",\"frameNodes\":\"Encadrer les nœuds\",\"frontendNewer\":\"La version du frontend {frontendVersion} peut ne pas être compatible avec la version du backend {backendVersion}.\",\"frontendOutdated\":\"La version du frontend {frontendVersion} est obsolète. Le backend requiert la version {requiredVersion} ou supérieure.\",\"galleryImage\":\"Image de la galerie\",\"galleryThumbnail\":\"Miniature de la galerie\",\"goToNode\":\"Aller au nœud\",\"graphNavigation\":\"Navigation dans le graphe\",\"halfSpeed\":\"0.5x\",\"hideLeftPanel\":\"Masquer le panneau de gauche\",\"hideRightPanel\":\"Masquer le panneau de droite\",\"icon\":\"Icône\",\"imageDoesNotExist\":\"L’image n’existe pas\",\"imageFailedToLoad\":\"Échec du chargement de l'image\",\"imagePreview\":\"Aperçu de l'image - Utilisez les flèches pour naviguer entre les images\",\"imageUrl\":\"URL de l'image\",\"import\":\"Importer\",\"inProgress\":\"En cours\",\"inSubgraph\":\"dans le sous-graphe «\xA0{name}\xA0»\",\"increment\":\"Augmenter\",\"info\":\"Informations du nœud\",\"input\":\"Entrée\",\"insert\":\"Insérer\",\"install\":\"Installer\",\"installed\":\"Installé\",\"installing\":\"Installation\",\"interrupted\":\"Interrompu\",\"itemSelected\":\"{selectedCount} élément sélectionné\",\"itemsCopiedToClipboard\":\"Éléments copiés dans le presse-papiers\",\"itemsSelected\":\"{selectedCount} éléments sélectionnés\",\"job\":\"Tâche\",\"jobIdCopied\":\"ID du travail copié dans le presse-papiers\",\"keybinding\":\"Raccourci clavier\",\"keybindingAlreadyExists\":\"Le raccourci clavier existe déjà\",\"keybindings\":\"Raccourcis clavier\",\"learnMore\":\"En savoir plus\",\"listening\":\"Écoute en cours...\",\"liveSamplingPreview\":\"Aperçu en temps réel\",\"loadAllFolders\":\"Charger tous les dossiers\",\"loadWorkflow\":\"Charger le flux de travail\",\"loading\":\"Chargement\",\"loadingPanel\":\"Chargement du panneau {panel}...\",\"login\":\"Connexion\",\"logoAlt\":\"Logo ComfyUI\",\"logs\":\"Journaux\",\"manageExtensions\":\"Gérer les extensions\",\"markdown\":\"markdown\",\"micPermissionDenied\":\"Permission du microphone refusée\",\"migrate\":\"Migrer\",\"missing\":\"Manquant\",\"more\":\"Plus\",\"moreOptions\":\"Plus d'options\",\"moreWorkflows\":\"Plus de workflows\",\"mostRelevant\":\"Les plus pertinents\",\"multiSelectDropdown\":\"Menu déroulant à sélection multiple\",\"name\":\"Nom\",\"newFolder\":\"Nouveau dossier\",\"next\":\"Suivant\",\"nightly\":\"NIGHTLY\",\"no\":\"Non\",\"noAudioRecorded\":\"Aucun audio enregistré\",\"noItems\":\"Aucun élément\",\"noResults\":\"Aucun résultat\",\"noResultsFound\":\"Aucun résultat trouvé\",\"noTasksFound\":\"Aucune tâche trouvée\",\"noTasksFoundMessage\":\"Il n'y a pas de tâches dans la file d'attente.\",\"noWorkflowsFound\":\"Aucun flux de travail trouvé.\",\"nodeContentError\":\"Erreur de contenu du nœud\",\"nodeHeaderError\":\"Erreur d'en-tête du nœud\",\"nodeRenderError\":\"Erreur de rendu du nœud\",\"nodeSlotsError\":\"Erreur d'emplacements du nœud\",\"nodeWidgetsError\":\"Erreur de widgets du nœud\",\"nodes\":\"Nœuds\",\"nodesCount\":\"{count} nœuds | {count} nœud | {count} nœuds\",\"nodesRunning\":\"nœuds en cours d’exécution\",\"none\":\"Aucun\",\"nothingToCopy\":\"Rien à copier\",\"nothingToDelete\":\"Rien à supprimer\",\"nothingToDuplicate\":\"Rien à dupliquer\",\"nothingToRename\":\"Rien à renommer\",\"ok\":\"OK\",\"openManager\":\"Ouvrir le gestionnaire\",\"openNewIssue\":\"Ouvrir un nouveau problème\",\"or\":\"ou\",\"output\":\"Sortie\",\"overwrite\":\"Écraser\",\"playPause\":\"Lecture/Pause\",\"playRecording\":\"Lire l'enregistrement\",\"playbackSpeed\":\"Vitesse de lecture\",\"playing\":\"Lecture en cours\",\"pressKeysForNewBinding\":\"Appuyez sur les touches pour une nouvelle liaison\",\"preview\":\"APERÇU\",\"profile\":\"Profil\",\"progressCountOf\":\"sur\",\"queued\":\"En file d’attente\",\"ready\":\"Prêt\",\"reconnected\":\"Reconnecté\",\"reconnecting\":\"Reconnexion\",\"refresh\":\"Rafraîchir\",\"refreshNode\":\"Actualiser le nœud\",\"relativeTime\":{\"daysAgo\":\"il y a {count}j\",\"hoursAgo\":\"il y a {count}h\",\"minutesAgo\":\"il y a {count}min\",\"monthsAgo\":\"il y a {count}mo\",\"now\":\"maintenant\",\"weeksAgo\":\"il y a {count}s\",\"yearsAgo\":\"il y a {count}a\"},\"releaseTitle\":\"Publication de {package} {version}\",\"reloadToApplyChanges\":\"Recharger pour appliquer les modifications\",\"remove\":\"Supprimer\",\"removeImage\":\"Supprimer l'image\",\"removeTag\":\"Supprimer le tag\",\"removeVideo\":\"Supprimer la vidéo\",\"rename\":\"Renommer\",\"reportIssue\":\"Envoyer le rapport\",\"reportIssueTooltip\":\"Soumettre le rapport d'erreur à Comfy Org\",\"reportSent\":\"Rapport soumis\",\"reset\":\"Réinitialiser\",\"resetAll\":\"Réinitialiser tout\",\"resetAllKeybindingsTooltip\":\"Réinitialiser tous les raccourcis clavier par défaut\",\"resizeFromBottomLeft\":\"Redimensionner depuis le coin inférieur gauche\",\"resizeFromBottomRight\":\"Redimensionner depuis le coin inférieur droit\",\"resizeFromTopLeft\":\"Redimensionner depuis le coin supérieur gauche\",\"resizeFromTopRight\":\"Redimensionner depuis le coin supérieur droit\",\"restart\":\"Redémarrer\",\"resultsCount\":\"{count} Résultats Trouvés\",\"running\":\"En cours\",\"save\":\"Enregistrer\",\"saving\":\"Enregistrement\",\"scrollLeft\":\"Faire défiler à gauche\",\"scrollRight\":\"Faire défiler à droite\",\"search\":\"Rechercher\",\"searchExtensions\":\"Rechercher des extensions\",\"searchFailedMessage\":\"Nous n'avons trouvé aucun paramètre correspondant à votre recherche. Essayez d'ajuster vos termes de recherche.\",\"searchKeybindings\":\"Rechercher des raccourcis clavier\",\"searchModels\":\"Rechercher des modèles\",\"searchNodes\":\"Rechercher des nœuds\",\"searchPlaceholder\":\"Rechercher...\",\"searchSettings\":\"Rechercher des paramètres\",\"searchWorkflows\":\"Rechercher des flux de travail\",\"seeTutorial\":\"Voir un tutoriel\",\"selectItemsToCopy\":\"Sélectionnez les éléments à copier\",\"selectItemsToDelete\":\"Sélectionnez les éléments à supprimer\",\"selectItemsToDuplicate\":\"Sélectionnez les éléments à dupliquer\",\"selectItemsToRename\":\"Sélectionnez les éléments à renommer\",\"selectedFile\":\"Fichier sélectionné\",\"setAsBackground\":\"Définir comme arrière-plan\",\"settings\":\"Paramètres\",\"shortcutSuffix\":\" ({shortcut})\",\"showLeftPanel\":\"Afficher le panneau de gauche\",\"showReport\":\"Afficher le rapport\",\"showRightPanel\":\"Afficher le panneau de droite\",\"singleSelectDropdown\":\"Menu déroulant à sélection unique\",\"sort\":\"Trier\",\"source\":\"Source\",\"startRecording\":\"Commencer l’enregistrement\",\"status\":\"Statut\",\"stopPlayback\":\"Arrêter la lecture\",\"stopRecording\":\"Arrêter l’enregistrement\",\"submit\":\"Soumettre\",\"success\":\"Succès\",\"systemInfo\":\"Informations système\",\"terminal\":\"Terminal\",\"title\":\"Titre\",\"triggerPhrase\":\"Phrase déclencheuse\",\"unknownError\":\"Erreur inconnue\",\"unknownFile\":\"Fichier inconnu\",\"untitled\":\"Sans titre\",\"update\":\"Mettre à jour\",\"updateAvailable\":\"Mise à jour disponible\",\"updateFrontend\":\"Mettre à jour le frontend\",\"updated\":\"Mis à jour\",\"updating\":\"Mise à jour\",\"upload\":\"Téléverser\",\"uploadAlreadyInProgress\":\"Téléversement déjà en cours\",\"usageHint\":\"Conseil d'utilisation\",\"use\":\"Utiliser\",\"user\":\"Utilisateur\",\"versionMismatchWarning\":\"Avertissement de compatibilité de version\",\"versionMismatchWarningMessage\":\"{warning} : {detail} Consultez https://docs.comfy.org/installation/update_comfyui#common-update-issues pour les instructions de mise à jour.\",\"videoFailedToLoad\":\"Échec du chargement de la vidéo\",\"videoPreview\":\"Aperçu de la vidéo - Utilisez les flèches pour naviguer entre les vidéos\",\"viewImageOfTotal\":\"Voir l'image {index} sur {total}\",\"viewVideoOfTotal\":\"Voir la vidéo {index} sur {total}\",\"volume\":\"Volume\",\"warning\":\"Avertissement\",\"workflow\":\"Flux de travail\",\"you\":\"Vous\"}");
...
const issueReport = { "helpFix": "Aidez à résoudre cela" };
const linearMode = {
	"appModeToolbar": {
...
const nodeCategories = {
	...
	"model_specific": "spécifique_au_modèle",
	"noise": "bruit",
...
const rightSidePanel = {
	...
	"pinned": "Épinglé",
	"promptErrors": {
		"no_prompt": { "desc": "Les données du flux de travail envoyées au serveur sont vides. Il peut s'agir d'une erreur système inattendue." },
		"prompt_no_outputs": { "desc": "Le flux de travail ne contient aucun nœud de sortie (par exemple, Enregistrer l'image, Prévisualiser l'image) pour produire un résultat." },
		"server_error_cloud": { "desc": "Le serveur a rencontré une erreur inattendue. Veuillez réessayer plus tard." },
		"server_error_local": { "desc": "Le serveur a rencontré une erreur inattendue. Veuillez consulter les journaux du serveur." }
	},
	"properties": "Propriétés",
...
const subscription = {
	...
	"billingComingSoon": {
		"message": "La facturation d'équipe arrive bientôt. Vous pourrez souscrire à un abonnement pour votre espace de travail avec un tarif par utilisateur. Restez à l'écoute pour les mises à jour.",
		"title": "Bientôt disponible"
	},
	"cancelDialog": {
		"confirmCancel": "Annuler l'abonnement",
		"description": "Votre accès continue jusqu'au {date}. Vous ne serez plus facturé, et votre espace de travail ainsi que vos crédits seront conservés. Vous pouvez vous réabonner à tout moment.",
		"endOfBillingPeriod": "fin de la période de facturation",
		"failed": "Échec de l'annulation de l'abonnement",
	...
	"freeTier": {
		...
		"topUpBlocked": { "title": "Débloquez les recharges et plus encore" },
	...
	"maxDurationLabel": "Durée maximale de chaque exécution de workflow",
	...
	"required": {
		...
		"pollingTimeout": "Délai d'attente de l'abonnement dépassé. Veuillez actualiser et réessayer.",
		"subscribe": "S'abonner",
		"title": "S'abonner à",
		"waitingForSubscription": "Complétez votre abonnement dans le nouvel onglet. Nous détecterons automatiquement quand vous aurez terminé !"
	},
	...
	"tiers": {
		...
		"founder": { "name": "Édition Fondateur" },
		"free": { "name": "Gratuit" },
		"pro": { "name": "Pro" },
		"standard": { "name": "Standard" }
	},
	"title": "Abonnement",
	"titleUnsubscribed": "Abonnez-vous à Comfy Cloud",
	...
	"videoEstimateTryTemplate": "Essayer ce modèle",
	"videoTemplateBasedCredits": "Vidéos générées avec Wan 2.2 Image to Video",
	"viewEnterprise": "Voir l'offre entreprise",
...
const templateWidgets = { "sort": { "searchPlaceholder": "Rechercher..." } };
const templateWorkflows = {
	...
	"sort": {
		...
		"vramLowToHigh": "Utilisation VRAM (faible à élevée)"
	},
	"sorting": "Trier par",
...
const vueNodesMigrationMainMenu = { "message": "Revenez à Nodes 2.0 à tout moment depuis le menu principal." };
const vueNodesSlot = { "iterative": "(Itératif)" };
const welcome = {
...
//# sourceMappingURL=main-9hDdrYl6.js.map
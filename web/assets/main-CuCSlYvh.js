...
const cloudFooter_needHelp = "ヘルプが必要ですか？";
const cloudForgotPassword_backToLogin = "ログインに戻る";
const cloudForgotPassword_didntReceiveEmail = "メールが届きませんでしたか？";
const cloudForgotPassword_emailLabel = "メールアドレス";
const cloudForgotPassword_emailPlaceholder = "メールアドレスを入力";
const cloudForgotPassword_emailRequired = "メールアドレスは必須です";
const cloudForgotPassword_instructions = "メールアドレスを入力すると、パスワードリセット用のリンクをお送りします。";
const cloudForgotPassword_passwordResetError = "パスワードリセットメールの送信に失敗しました";
const cloudForgotPassword_passwordResetSent = "パスワードリセットを送信しました";
const cloudForgotPassword_sendResetLink = "リセットリンクを送信";
const cloudForgotPassword_title = "パスワードを忘れた場合";
...
const cloudPrivateBeta_desc = "ウェイトリストに参加するにはサインインしてください。順番が来たら通知します。既に通知を受け取りましたか？サインインしてクラウドの使用を開始してください。";
const cloudPrivateBeta_title = "クラウドは現在プライベートベータ版です";
const cloudSorryContactSupport_title = "申し訳ありません、サポートに連絡してください";
const cloudStart_desc = "セットアップ不要。あらゆるデバイスで動作します。";
const cloudStart_download = "ComfyUIをダウンロード";
const cloudStart_explain = "複数の出力を一度に生成。ワークフローを簡単に共有。";
const cloudStart_learnAboutButton = "クラウドについて学ぶ";
const cloudStart_title = "数秒で作成を開始";
const cloudStart_wantToRun = "代わりにローカルでComfyUIを実行したいですか？";
const cloudSurvey_steps_familiarity = "ComfyUIにどの程度精通していますか？";
const cloudSurvey_steps_industry = "あなたの主な業界は何ですか？";
const cloudSurvey_steps_making = "何を作成する予定ですか？";
const cloudSurvey_steps_purpose = "ComfyUIを主に何に使用しますか？";
const cloudWaitlist_contactLink = "こちら";
const cloudWaitlist_questionsText = "質問がありますか？お問い合わせください";
const color = {
	"black": "黒",
	"blue": "青",
	"brown": "ブラウン",
...
const desktopStart = { "initialising": "初期化中..." };
const desktopUpdate = {
...
const g = /* @__PURE__ */ JSON.parse("{\"1x\":\"1倍速\",\"2x\":\"2倍速\",\"about\":\"情報\",\"add\":\"追加\",\"addNode\":\"ノードを追加...\",\"addNodeFilterCondition\":\"ノードフィルター条件を追加\",\"all\":\"すべて\",\"amount\":\"量\",\"apply\":\"適用する\",\"architecture\":\"アーキテクチャ\",\"asset\":\"{count} 個のアセット | {count} 個のアセット | {count} 個のアセット\",\"audioFailedToLoad\":\"オーディオの読み込みに失敗しました\",\"audioProgress\":\"オーディオの進捗\",\"author\":\"作者\",\"back\":\"戻る\",\"batchRename\":\"一括リネーム\",\"beta\":\"ベータ版\",\"bookmark\":\"ライブラリに保存\",\"calculatingDimensions\":\"寸法を計算中\",\"cancel\":\"キャンセル\",\"cancelled\":\"キャンセル済み\",\"capture\":\"キャプチャ\",\"category\":\"カテゴリ\",\"chart\":\"チャート\",\"chartLowercase\":\"チャート\",\"choose_file_to_upload\":\"アップロードするファイルを選択\",\"clear\":\"クリア\",\"clearAll\":\"すべてクリア\",\"clearFilters\":\"フィルターをクリア\",\"close\":\"閉じる\",\"closeDialog\":\"ダイアログを閉じる\",\"color\":\"色\",\"comfy\":\"Comfy\",\"comfyOrgLogoAlt\":\"ComfyOrgロゴ\",\"comingSoon\":\"近日公開\",\"command\":\"コマンド\",\"commandProhibited\":\"コマンド {command} は禁止されています。詳細は管理者にお問い合わせください。\",\"community\":\"コミュニティ\",\"completed\":\"完了\",\"completedWithCheckmark\":\"完了 ✓\",\"confirm\":\"確認\",\"confirmed\":\"確認済み\",\"content\":\"コンテンツ\",\"continue\":\"続ける\",\"control_after_generate\":\"生成後の制御\",\"control_before_generate\":\"生成前の制御\",\"copied\":\"コピーしました\",\"copy\":\"コピー\",\"copyAll\":\"すべてコピー\",\"copyJobId\":\"ジョブIDをコピー\",\"copyToClipboard\":\"クリップボードにコピー\",\"copyURL\":\"URLをコピー\",\"core\":\"コア\",\"currentUser\":\"現在のユーザー\",\"custom\":\"カスタム\",\"customBackground\":\"カスタム背景\",\"customize\":\"カスタマイズ\",\"customizeFolder\":\"フォルダーをカスタマイズ\",\"decrement\":\"減少\",\"defaultBanner\":\"デフォルトバナー\",\"delete\":\"削除\",\"deleteAudioFile\":\"オーディオファイルを削除\",\"deleteImage\":\"画像を削除\",\"deprecated\":\"非推奨\",\"description\":\"説明\",\"devOnly\":\"DEV\",\"devices\":\"デバイス\",\"disableAll\":\"すべて無効にする\",\"disableSelected\":\"選択したものを無効化\",\"disableThirdParty\":\"サードパーティを無効化\",\"disabling\":\"無効化\",\"disconnectedFromBackend\":\"バックエンドから切断されました。サーバーが稼働しているか確認してください。\",\"dismiss\":\"閉じる\",\"download\":\"ダウンロード\",\"downloadAudio\":\"オーディオをダウンロード\",\"downloadImage\":\"画像をダウンロード\",\"downloadVideo\":\"ビデオをダウンロード\",\"downloadWithSize\":\"ダウンロード（{size}）\",\"downloading\":\"ダウンロード中\",\"dropYourFileOr\":\"ファイルをドロップするか\",\"duplicate\":\"複製\",\"edit\":\"編集\",\"editImage\":\"画像を編集\",\"editOrMaskImage\":\"画像を編集またはマスク\",\"emDash\":\"—\",\"empty\":\"空\",\"enableAll\":\"すべて有効にする\",\"enableOrDisablePack\":\"パックを有効/無効にする\",\"enableSelected\":\"選択したものを有効化\",\"enabled\":\"有効\",\"enabling\":\"有効化\",\"enter\":\"入力\",\"enterBaseName\":\"ベース名を入力\",\"enterNewName\":\"新しい名前を入力\",\"enterNewNamePrompt\":\"新しい名前を入力してください：\",\"enterSubgraph\":\"サブグラフに入る\",\"error\":\"エラー\",\"errorLoadingImage\":\"画像の読み込みエラー\",\"errorLoadingVideo\":\"ビデオの読み込みエラー\",\"essentials\":\"必須\",\"experimental\":\"ベータ\",\"export\":\"エクスポート\",\"extensionName\":\"拡張機能名\",\"extensions\":\"拡張機能\",\"failed\":\"失敗\",\"failedToCopyJobId\":\"ジョブIDのコピーに失敗しました\",\"failedToDownloadImage\":\"画像のダウンロードに失敗しました\",\"failedToDownloadVideo\":\"ビデオのダウンロードに失敗しました\",\"favorites\":\"お気に入り\",\"feedback\":\"フィードバック\",\"file\":\"ファイル\",\"filter\":\"フィルタ\",\"filterBy\":\"フィルター:\",\"filterByType\":\"{type}でフィルター...\",\"findIssues\":\"問題を見つける\",\"frameNodes\":\"ノードをフレーム化\",\"frontendNewer\":\"フロントエンドのバージョン {frontendVersion} はバックエンドのバージョン {backendVersion} と互換性がない可能性があります。\",\"frontendOutdated\":\"フロントエンドのバージョン {frontendVersion} は古くなっています。バックエンドは {requiredVersion} 以上が必要です。\",\"galleryImage\":\"ギャラリー画像\",\"galleryThumbnail\":\"ギャラリーサムネイル\",\"goToNode\":\"ノードに移動\",\"graphNavigation\":\"グラフナビゲーション\",\"halfSpeed\":\"0.5倍速\",\"hideLeftPanel\":\"左パネルを非表示\",\"hideRightPanel\":\"右パネルを非表示\",\"icon\":\"アイコン\",\"imageDoesNotExist\":\"画像が存在しません\",\"imageFailedToLoad\":\"画像の読み込みに失敗しました\",\"imagePreview\":\"画像プレビュー - 矢印キーで画像を切り替え\",\"imageUrl\":\"画像URL\",\"import\":\"インポート\",\"inProgress\":\"進行中\",\"inSubgraph\":\"サブグラフ「{name}」内\",\"increment\":\"増加\",\"info\":\"ノード情報\",\"input\":\"入力\",\"insert\":\"挿入\",\"install\":\"インストール\",\"installed\":\"インストール済み\",\"installing\":\"インストール中\",\"interrupted\":\"中断されました\",\"itemSelected\":\"{selectedCount}件選択済み\",\"itemsCopiedToClipboard\":\"項目をクリップボードにコピーしました\",\"itemsSelected\":\"{selectedCount}件選択済み\",\"job\":\"ジョブ\",\"jobIdCopied\":\"ジョブIDがクリップボードにコピーされました\",\"keybinding\":\"キーバインディング\",\"keybindingAlreadyExists\":\"このキー割り当てはすでに存在します\",\"keybindings\":\"キーバインド\",\"learnMore\":\"詳細を学ぶ\",\"listening\":\"リスニング中...\",\"liveSamplingPreview\":\"ライブサンプリングプレビュー\",\"loadAllFolders\":\"すべてのフォルダーを読み込む\",\"loadWorkflow\":\"ワークフローを読み込む\",\"loading\":\"読み込み中\",\"loadingPanel\":\"{panel} パネルを読み込み中...\",\"login\":\"ログイン\",\"logoAlt\":\"ComfyUIロゴ\",\"logs\":\"ログ\",\"manageExtensions\":\"拡張機能の管理\",\"markdown\":\"マークダウン\",\"micPermissionDenied\":\"マイクの許可が拒否されました\",\"migrate\":\"移行する\",\"missing\":\"不足している\",\"more\":\"もっと見る\",\"moreOptions\":\"その他のオプション\",\"moreWorkflows\":\"さらに多くのワークフロー\",\"mostRelevant\":\"最も関連性の高い\",\"multiSelectDropdown\":\"複数選択ドロップダウン\",\"name\":\"名前\",\"newFolder\":\"新しいフォルダー\",\"next\":\"次へ\",\"nightly\":\"NIGHTLY\",\"no\":\"いいえ\",\"noAudioRecorded\":\"音声が録音されていません\",\"noItems\":\"項目がありません\",\"noResults\":\"結果なし\",\"noResultsFound\":\"結果が見つかりません\",\"noTasksFound\":\"タスクが見つかりません\",\"noTasksFoundMessage\":\"キューにタスクがありません。\",\"noWorkflowsFound\":\"ワークフローが見つかりません。\",\"nodeContentError\":\"ノード内容エラー\",\"nodeHeaderError\":\"ノードヘッダーエラー\",\"nodeRenderError\":\"ノード描画エラー\",\"nodeSlotsError\":\"ノードスロットエラー\",\"nodeWidgetsError\":\"ノードウィジェットエラー\",\"nodes\":\"ノード\",\"nodesCount\":\"{count} ノード | {count} ノード | {count} ノード\",\"nodesRunning\":\"ノードが実行中\",\"none\":\"なし\",\"nothingToCopy\":\"コピーするものがありません\",\"nothingToDelete\":\"削除するものがありません\",\"nothingToDuplicate\":\"複製するものがありません\",\"nothingToRename\":\"リネームするものがありません\",\"ok\":\"OK\",\"openManager\":\"マネージャーを開く\",\"openNewIssue\":\"新しい問題を開く\",\"or\":\"または\",\"output\":\"出力\",\"overwrite\":\"上書き\",\"playPause\":\"再生/一時停止\",\"playRecording\":\"録音を再生\",\"playbackSpeed\":\"再生速度\",\"playing\":\"再生中\",\"pressKeysForNewBinding\":\"新しいバインドのキーを押してください\",\"preview\":\"プレビュー\",\"profile\":\"プロフィール\",\"progressCountOf\":\"の\",\"queued\":\"キュー中\",\"ready\":\"準備完了\",\"reconnected\":\"再接続されました\",\"reconnecting\":\"再接続中\",\"refresh\":\"更新\",\"refreshNode\":\"ノードを更新\",\"relativeTime\":{\"daysAgo\":\"{count}日前\",\"hoursAgo\":\"{count}時間前\",\"minutesAgo\":\"{count}分前\",\"monthsAgo\":\"{count}か月前\",\"now\":\"今\",\"weeksAgo\":\"{count}週間前\",\"yearsAgo\":\"{count}年前\"},\"releaseTitle\":\"{package} {version} リリース\",\"reloadToApplyChanges\":\"変更を適用するには再読み込みしてください\",\"remove\":\"削除\",\"removeImage\":\"画像を削除\",\"removeTag\":\"タグを削除\",\"removeVideo\":\"ビデオを削除\",\"rename\":\"名前を変更\",\"reportIssue\":\"報告する\",\"reportIssueTooltip\":\"エラーレポートをComfy Orgに送信\",\"reportSent\":\"レポートが送信されました\",\"reset\":\"リセット\",\"resetAll\":\"すべてリセット\",\"resetAllKeybindingsTooltip\":\"すべてのキーバインディングをデフォルトにリセット\",\"resizeFromBottomLeft\":\"左下隅からリサイズ\",\"resizeFromBottomRight\":\"右下隅からリサイズ\",\"resizeFromTopLeft\":\"左上隅からリサイズ\",\"resizeFromTopRight\":\"右上隅からリサイズ\",\"restart\":\"再起動\",\"resultsCount\":\"{count}件の結果が見つかりました\",\"running\":\"実行中\",\"save\":\"保存\",\"saving\":\"保存中\",\"scrollLeft\":\"左にスクロール\",\"scrollRight\":\"右にスクロール\",\"search\":\"検索\",\"searchExtensions\":\"拡張機能を検索\",\"searchFailedMessage\":\"検索に一致する設定が見つかりませんでした。検索キーワードを調整してみてください。\",\"searchKeybindings\":\"キーバインディングを検索\",\"searchModels\":\"モデルを検索\",\"searchNodes\":\"ノードを検索\",\"searchPlaceholder\":\"検索...\",\"searchSettings\":\"設定を検索\",\"searchWorkflows\":\"ワークフローを検索\",\"seeTutorial\":\"チュートリアルを見る\",\"selectItemsToCopy\":\"コピーする項目を選択\",\"selectItemsToDelete\":\"削除する項目を選択\",\"selectItemsToDuplicate\":\"複製する項目を選択\",\"selectItemsToRename\":\"リネームする項目を選択\",\"selectedFile\":\"選択されたファイル\",\"setAsBackground\":\"背景として設定\",\"settings\":\"設定\",\"shortcutSuffix\":\"（{shortcut}）\",\"showLeftPanel\":\"左パネルを表示\",\"showReport\":\"レポートを表示\",\"showRightPanel\":\"右パネルを表示\",\"singleSelectDropdown\":\"単一選択ドロップダウン\",\"sort\":\"並び替え\",\"source\":\"ソース\",\"startRecording\":\"録音開始\",\"status\":\"ステータス\",\"stopPlayback\":\"再生を停止\",\"stopRecording\":\"録音停止\",\"submit\":\"送信\",\"success\":\"成功\",\"systemInfo\":\"システム情報\",\"terminal\":\"ターミナル\",\"title\":\"タイトル\",\"triggerPhrase\":\"トリガーフレーズ\",\"unknownError\":\"不明なエラー\",\"unknownFile\":\"不明なファイル\",\"untitled\":\"無題\",\"update\":\"更新\",\"updateAvailable\":\"更新が利用可能\",\"updateFrontend\":\"フロントエンドを更新\",\"updated\":\"更新済み\",\"updating\":\"更新中\",\"upload\":\"アップロード\",\"uploadAlreadyInProgress\":\"アップロードはすでに進行中です\",\"usageHint\":\"使用ヒント\",\"use\":\"使用\",\"user\":\"ユーザー\",\"versionMismatchWarning\":\"バージョン互換性の警告\",\"versionMismatchWarningMessage\":\"{warning}: {detail} 更新手順については https://docs.comfy.org/installation/update_comfyui#common-update-issues をご覧ください。\",\"videoFailedToLoad\":\"ビデオの読み込みに失敗しました\",\"videoPreview\":\"ビデオプレビュー - 矢印キーでビデオを切り替え\",\"viewImageOfTotal\":\"画像 {index} / {total} を表示\",\"viewVideoOfTotal\":\"ビデオ {index} / {total} を表示\",\"volume\":\"音量\",\"warning\":\"警告\",\"workflow\":\"ワークフロー\",\"you\":\"あなた\"}");
...
const issueReport = { "helpFix": "これを修正するのを助ける" };
const linearMode = {
	"appModeToolbar": {
		"appBuilder": "アプリビルダー",
		"apps": "アプリ"
...
const rightSidePanel = {
	...
	"pinned": "ピン留め",
	"promptErrors": {
		"no_prompt": { "desc": "サーバーに送信されたワークフローデータが空です。これは予期しないシステムエラーの可能性があります。" },
		"prompt_no_outputs": { "desc": "ワークフローに結果を生成する出力ノード（例：画像を保存、画像をプレビュー）が含まれていません。" },
		"server_error_cloud": { "desc": "サーバーで予期しないエラーが発生しました。しばらくしてから再度お試しください。" },
		"server_error_local": { "desc": "サーバーで予期しないエラーが発生しました。サーバーログをご確認ください。" }
	},
	"properties": "プロパティ",
...
const subscription = {
	...
	"billingComingSoon": {
		"message": "チーム向けの請求機能が近日中に追加されます。ワークスペースごとに席数単位でプランに加入できるようになります。今後のアップデートをお待ちください。",
		"title": "近日公開"
	},
	"cancelDialog": {
		"confirmCancel": "サブスクリプションをキャンセル",
		"description": "アクセスは{date}まで継続されます。今後請求されることはなく、ワークスペースとクレジットは保持されます。いつでも再購読できます。",
		"endOfBillingPeriod": "請求期間の終了",
		"failed": "サブスクリプションのキャンセルに失敗しました",
	...
	"freeTier": {
		...
		"subscribeCta": "さらに詳しく",
		"title": "無料プランをご利用中です",
		"topUpBlocked": { "title": "チャージや追加機能をアンロック" },
		"upgradeCta": "プランを見る"
	},
	...
	"maxDurationLabel": "各ワークフロー実行の最大時間",
	...
	"required": {
		...
		"pollingTimeout": "サブスクリプションの待機がタイムアウトしました。再読み込みして再試行してください。",
		"subscribe": "購読する",
		"title": "購読する",
		"waitingForSubscription": "新しいタブで購読を完了してください。完了を自動的に検知します！"
	},
	"resubscribe": "再購読する",
	...
	"tiers": {
		"creator": { "name": "クリエイター" },
		"founder": { "name": "ファウンダーエディション" },
		"free": { "name": "無料" },
		"pro": { "name": "プロ" },
		"standard": { "name": "スタンダード" }
	},
	"title": "サブスクリプション",
	"titleUnsubscribed": "Comfy Cloudにサブスクライブ",
	"totalCredits": "総クレジット",
	"upgrade": "アップグレード",
	...
	"videoEstimateTryTemplate": "このテンプレートを試す",
	"videoTemplateBasedCredits": "Wan 2.2 画像から動画で生成された動画",
	"viewEnterprise": "エンタープライズを見る",
...
const templateWidgets = { "sort": { "searchPlaceholder": "検索..." } };
...
const vueNodesMigrationMainMenu = { "message": "メインメニューからいつでもNodes 2.0に戻せます。" };
const vueNodesSlot = { "iterative": "（反復）" };
const welcome = {
	"getStarted": "はじめる",
	"title": "ComfyUIへようこそ"
};
...
//# sourceMappingURL=main-CuCSlYvh.js.map
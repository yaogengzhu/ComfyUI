...
import { B as script$5, ct as useToast, i as script, it as script$4, n as h, rt as script$1, tt as script$2, x as script$3 } from "./vendor-primevue-CN8WO3jr.js";
...
import { i as remoteConfig, r as configValueOrDefault } from "./useFeatureFlags-BuKVU3gG.js";
import { nn as useThrottleFn } from "./vendor-reka-ui-C_KZ-Z9x.js";
...
import { R as isInChina, Zr as useFirebaseAuthActions, ai as useApiKeyAuthStore, ji as getComfyPlatformBaseUrl, r as useFirebaseAuthStore } from "./teamWorkspaceStore-CrgYR715.js";
...
import { n as signInSchema, t as apiKeySchema } from "./signInSchema-CaxQhwd2.js";
import "./PasswordFields-Crx8qdt0.js";
import { t as SignUpForm_default } from "./SignUpForm-BfO3dsAc.js";
...
var _hoisted_13 = { class: "mt-4 flex items-center justify-between" };
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$2, [createBaseVNode("div", _hoisted_2$2, [createBaseVNode("h1", _hoisted_3$2, toDisplayString(unref(t)("auth.apiKey.title")), 1), createBaseVNode("div", _hoisted_4$2, [createBaseVNode("p", _hoisted_5$2, toDisplayString(unref(t)("auth.apiKey.description")), 1), createBaseVNode("a", _hoisted_6$2, toDisplayString(unref(t)("g.learnMore")), 1)])]), createVNode(unref(script), {
				...
				default: withCtx(($form) => [
					...
					createBaseVNode("div", _hoisted_13, [createVNode(Button_default, {
						type: "button",
						variant: "textonly",
...
var _hoisted_8 = { class: "text-center text-muted" };
var _hoisted_9 = ["href"];
var _hoisted_10 = { class: "mt-8 text-xs text-muted" };
var _hoisted_11 = {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1, [showApiKeyForm.value ? (openBlock(), createBlock(ApiKeyForm_default, {
				...
				createBaseVNode("div", _hoisted_7, [
					...
					createVNode(Button_default, {
						...
						default: withCtx(() => [_cache[4] || (_cache[4] = createBaseVNode("img", {
							...
							class: "mr-2 h-5 w-5",
							alt: "绘智 AI"
						}, null, -1)), createTextVNode(" " + toDisplayString(unref(t)("auth.login.useApiKey")), 1)]),
						_: 1
					}),
					createBaseVNode("small", _hoisted_8, [createTextVNode(toDisplayString(unref(t)("auth.apiKey.helpText")) + " ", 1), createBaseVNode("a", {
						href: `${comfyPlatformBaseUrl.value}/login`,
						target: "_blank",
						class: "cursor-pointer text-blue-500"
					}, toDisplayString(unref(t)("auth.apiKey.generateKey")), 9, _hoisted_9)]),
				...
				createBaseVNode("p", _hoisted_10, [
					...
					createBaseVNode("a", _hoisted_11, toDisplayString(unref(t)("auth.login.termsLink")), 1),
					createTextVNode(" " + toDisplayString(unref(t)("auth.login.andText")) + " ", 1),
					createBaseVNode("a", _hoisted_12, toDisplayString(unref(t)("auth.login.privacyLink")), 1),
...
//# sourceMappingURL=SignInContent-D8SSX9Ix.js.map
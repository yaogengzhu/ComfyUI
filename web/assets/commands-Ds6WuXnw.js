...
const Comfy_MaskEditor_ColorPicker = { "label": "Abrir selector de color en MaskEditor" };
const Comfy_MaskEditor_Mirror_Horizontal = { "label": "Espejar horizontalmente en MaskEditor" };
const Comfy_MaskEditor_Mirror_Vertical = { "label": "Espejar verticalmente en MaskEditor" };
const Comfy_MaskEditor_OpenMaskEditor = { "label": "Abrir editor de máscara para el nodo seleccionado" };
const Comfy_MaskEditor_Rotate_Left = { "label": "Girar a la izquierda en MaskEditor" };
const Comfy_MaskEditor_Rotate_Right = { "label": "Girar a la derecha en MaskEditor" };
...
const Comfy_Queue_ToggleOverlay = { "label": "Alternar historial de trabajos" };
const Comfy_Redo = { "label": "Rehacer" };
const Comfy_RefreshNodeDefinitions = { "label": "Actualizar Definiciones de Nodo" };
const Comfy_RenameWorkflow = { "label": "Renombrar flujo de trabajo" };
...
const Comfy_Subgraph_SetDescription = { "label": "Establecer descripción del subgrafo" };
const Comfy_Subgraph_SetSearchAliases = { "label": "Establecer alias de búsqueda del subgrafo" };
...
const Comfy_ToggleLinear = { "label": "alternar modo lineal" };
const Comfy_ToggleQPOV2 = { "label": "Alternar Panel de Cola V2" };
...
//# sourceMappingURL=commands-Ds6WuXnw.js.map
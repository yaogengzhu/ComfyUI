...
const Comfy_Canvas_CopySelected = { "label": "コピー" };
...
const Comfy_Canvas_PasteFromClipboard = { "label": "貼り付け" };
const Comfy_Canvas_ResetView = { "label": "ビューをリセット" };
const Comfy_Canvas_Resize = { "label": "選択したノードのサイズ変更" };
const Comfy_Canvas_SelectAll = { "label": "すべて選択" };
...
const Comfy_MaskEditor_ColorPicker = { "label": "MaskEditorでカラーピッカーを開く" };
const Comfy_MaskEditor_Mirror_Horizontal = { "label": "マスクエディタで左右反転" };
const Comfy_MaskEditor_Mirror_Vertical = { "label": "マスクエディタで上下反転" };
const Comfy_MaskEditor_OpenMaskEditor = { "label": "選択したノードのマスクエディタを開く" };
const Comfy_MaskEditor_Rotate_Left = { "label": "マスクエディタで左回転" };
const Comfy_MaskEditor_Rotate_Right = { "label": "マスクエディタで右回転" };
...
const Comfy_Queue_ToggleOverlay = { "label": "ジョブ履歴を切り替え" };
const Comfy_Redo = { "label": "やり直す" };
const Comfy_RefreshNodeDefinitions = { "label": "ノード定義を更新" };
const Comfy_RenameWorkflow = { "label": "ワークフローの名前を変更" };
...
const Comfy_Subgraph_SetDescription = { "label": "サブグラフの説明を設定" };
const Comfy_Subgraph_SetSearchAliases = { "label": "サブグラフの検索エイリアスを設定" };
...
const Comfy_ToggleLinear = { "label": "リニアモードを切り替え" };
const Comfy_ToggleQPOV2 = { "label": "Queue Panel V2 を切り替え" };
...
//# sourceMappingURL=commands-Hw874jz6.js.map
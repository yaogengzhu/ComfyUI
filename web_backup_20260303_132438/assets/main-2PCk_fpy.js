...
const apiNodesCostBreakdown = {
	"costPerRun": "Стоимость за запуск",
	"title": "API Node(s)",
	"totalCost": "Общая стоимость"
};
const apiNodesSignInDialog = {
...
const auth = {
	...
	"deleteAccount": { "contactSupport": "Чтобы удалить свою учетную запись, пожалуйста, свяжитесь с {email}" },
	"errors": {
...
const batch = { "index": "{current} / {total}" };
...
const cloudFooter_needHelp = "Нужна помощь?";
const cloudForgotPassword_backToLogin = "Вернуться к входу";
const cloudForgotPassword_didntReceiveEmail = "Не получили письмо?";
const cloudForgotPassword_emailLabel = "Электронная почта";
const cloudForgotPassword_emailPlaceholder = "Введите вашу электронную почту";
const cloudForgotPassword_emailRequired = "Требуется указать электронную почту";
const cloudForgotPassword_instructions = "Введите свой адрес электронной почты, и мы вышлем вам ссылку для сброса пароля.";
const cloudForgotPassword_passwordResetError = "Не удалось отправить письмо для сброса пароля";
const cloudForgotPassword_passwordResetSent = "Запрос на сброс пароля отправлен";
const cloudForgotPassword_sendResetLink = "Отправить ссылку для сброса";
const cloudForgotPassword_title = "Забыли пароль";
...
const cloudPrivateBeta_desc = "Войдите, чтобы присоединиться к списку ожидания. Мы уведомим вас, когда подойдет ваша очередь. Уже получили уведомление? Войдите, чтобы начать использовать Cloud.";
const cloudPrivateBeta_title = "Cloud сейчас в закрытой бета-версии";
const cloudSorryContactSupport_title = "Извините, обратитесь в службу поддержки";
const cloudStart_desc = "Не требует настройки. Работает на любом устройстве.";
const cloudStart_download = "Скачать ComfyUI";
const cloudStart_explain = "Генерируйте несколько результатов одновременно. Легко делитесь рабочими процессами.";
const cloudStart_learnAboutButton = "Узнать о Cloud";
const cloudStart_title = "начать создавать за секунды";
const cloudStart_wantToRun = "Хотите запустить ComfyUI локально?";
const cloudSurvey_steps_familiarity = "Насколько вы знакомы с ComfyUI?";
const cloudSurvey_steps_industry = "В какой отрасли вы работаете?";
const cloudSurvey_steps_making = "Что вы планируете создавать?";
const cloudSurvey_steps_purpose = "Для чего вы в основном будете использовать ComfyUI?";
const cloudWaitlist_contactLink = "здесь";
const cloudWaitlist_questionsText = "Есть вопросы? Свяжитесь с нами";
const color = {
	"black": "Черный",
	"blue": "Синий",
	"brown": "Коричневый",
...
const desktopStart = { "initialising": "Инициализация..." };
const desktopUpdate = {
...
const manager = {
	...
	"packInstall": { "nodeIdRequired": "Для установки требуется идентификатор узла" },
...
const rightSidePanel = {
	...
	"pinned": "Закреплено",
	"promptErrors": {
		"no_prompt": { "desc": "Данные рабочего процесса, отправленные на сервер, пусты. Это может быть неожиданной системной ошибкой." },
		"prompt_no_outputs": { "desc": "В рабочем процессе отсутствуют выходные узлы (например, Сохранить изображение, Предпросмотр изображения) для получения результата." },
		"server_error_cloud": { "desc": "На сервере произошла непредвиденная ошибка. Пожалуйста, попробуйте позже." },
		"server_error_local": { "desc": "На сервере произошла непредвиденная ошибка. Пожалуйста, проверьте логи сервера." }
	},
	"properties": "Свойства",
...
const templateWidgets = { "sort": { "searchPlaceholder": "Поиск..." } };
...
const templates = { "logoProviderSeparator": " & " };
const toastMessages = {
...
const vueNodesBanner = {
	"desc": "– Более гибкие рабочие процессы, новые мощные виджеты, расширяемость",
	"title": "Представляем Nodes 2.0",
	"tryItOut": "Попробовать"
};
const vueNodesMigration = {
	"button": "Открыть настройки",
	"message": "Предпочитаете классический дизайн узлов?"
};
const vueNodesMigrationMainMenu = { "message": "Переключиться обратно на Nodes 2.0 можно в главном меню." };
const vueNodesSlot = { "iterative": "(Итеративно)" };
const welcome = {
	"getStarted": "Начать",
...
const workspacePanel = {
	...
	"dashboard": { "placeholder": "Настройки рабочего пространства" },
	"deleteDialog": {
...
export { actionbar, apiNodesCostBreakdown, apiNodesSignInDialog, assetBrowser, auth, batch, billingOperation, boundingBox, breadcrumbsMenu, builderMenu, builderToolbar, clipboard, cloudFooter_needHelp, cloudForgotPassword_backToLogin, cloudForgotPassword_didntReceiveEmail, cloudForgotPassword_emailLabel, cloudForgotPassword_emailPlaceholder, cloudForgotPassword_emailRequired, cloudForgotPassword_instructions, cloudForgotPassword_passwordResetError, cloudForgotPassword_passwordResetSent, cloudForgotPassword_sendResetLink, cloudForgotPassword_title, cloudOnboarding, cloudPrivateBeta_desc, cloudPrivateBeta_title, cloudSorryContactSupport_title, cloudStart_desc, cloudStart_download, cloudStart_explain, cloudStart_learnAboutButton, cloudStart_title, cloudStart_wantToRun, cloudSurvey_steps_familiarity, cloudSurvey_steps_industry, cloudSurvey_steps_making, cloudSurvey_steps_purpose, cloudWaitlist_contactLink, cloudWaitlist_questionsText, color, commands, contextMenu, credits, dataTypes, main_default as default, desktopDialogs, desktopMenu, desktopStart, desktopUpdate, downloadGit, electronFileDownload, errorDialog, errorOverlay, essentials, exportToast, g, graphCanvasMenu, groupNode, help, helpCenter, icon, imageCompare, imageCrop, importFailed, install, issueReport, linearMode, load3d, loadWorkflowWarning, maintenance, manager, maskEditor, mediaAsset, menu, menuLabels, minimap, missingModelsDialog, missingNodes, nightly, nightlySurvey, nodeCategories, nodeErrors, nodeFilters, nodeHelpPage, nodeReplacement, nodeTemplates, notSupported, painter, progressToast, queue, releaseToast, rightSidePanel, secrets, selectionToolbox, serverConfig, serverConfigCategories, serverConfigItems, serverStart, settingsCategories, shape, shortcuts, sideToolbar, subgraphStore, subscription, tabMenu, templateWidgets, templateWorkflows, templates, toastMessages, userSelect, userSettings, validation, versionMismatchWarning, vueNodesBanner, vueNodesMigration, vueNodesMigrationMainMenu, vueNodesSlot, welcome, whatsNewPopup, widgetFileUpload, widgets, workflowService, workspace, workspaceAuth, workspacePanel, workspaceSwitcher, zoomControls };

//# sourceMappingURL=main-2PCk_fpy.js.map
...
const Comfy_ConfirmClear = { "name": "نیاز به تأیید هنگام پاک‌سازی workflow" };
const Comfy_DOMClippingEnabled = { "name": "فعال‌سازی برش عناصر DOM (فعال‌سازی ممکن است عملکرد را کاهش دهد)" };
const Comfy_DevMode = { "name": "فعال‌سازی گزینه‌های حالت توسعه (ذخیره API و غیره)" };
...
const Comfy_DisableSliders = { "name": "غیرفعال‌سازی اسلایدرهای ابزارک node" };
const Comfy_EditAttention_Delta = { "name": "دقت Ctrl+بالا/پایین" };
const Comfy_EnableTooltips = { "name": "فعال‌سازی راهنماها" };
const Comfy_EnableWorkflowViewRestore = { "name": "ذخیره و بازیابی موقعیت و سطح بزرگ‌نمایی بوم در workflowها" };
...
const Comfy_Graph_CanvasInfo = { "name": "نمایش اطلاعات بوم در گوشه پایین سمت چپ (fps و غیره)" };
const Comfy_Graph_CanvasMenu = { "name": "نمایش منوی بوم گراف" };
const Comfy_Graph_CtrlShiftZoom = { "name": "فعال‌سازی میانبر بزرگ‌نمایی سریع (Ctrl + Shift + کشیدن)" };
...
const Comfy_Graph_ZoomSpeed = { "name": "سرعت بزرگ‌نمایی بوم" };
const Comfy_GroupSelectedNodes_Padding = { "name": "فاصله داخلی nodeهای انتخاب‌شده در گروه" };
const Comfy_Group_DoubleClickTitleToEdit = { "name": "دوبار کلیک روی عنوان گروه برای ویرایش" };
...
const Comfy_NodeBadge_ShowApiPricing = { "name": "نمایش نشان قیمت‌گذاری API نود" };
...
const Comfy_Node_AllowImageSizeDraw = { "name": "نمایش عرض × ارتفاع زیر پیش‌نمایش تصویر" };
...
const Comfy_Node_DoubleClickTitleToEdit = { "name": "ویرایش عنوان نود با دوبار کلیک" };
const Comfy_Node_MiddleClickRerouteNode = { "name": "ایجاد نود Reroute با کلیک وسط" };
const Comfy_Node_Opacity = { "name": "شفافیت نود" };
...
const Comfy_PromptFilename = { "name": "درخواست نام فایل هنگام ذخیره workflow" };
...
const Comfy_Sidebar_UnifiedWidth = { "name": "عرض یکپارچه نوار کناری" };
...
const Comfy_TextareaWidget_FontSize = { "name": "اندازه فونت ابزارک textarea" };
const Comfy_TextareaWidget_Spellcheck = { "name": "بررسی املای ابزارک textarea" };
const Comfy_TreeExplorer_ItemPadding = { "name": "فاصله داخلی آیتم‌های مرورگر درختی" };
...
const Comfy_Validation_Workflows = { "name": "اعتبارسنجی workflowها" };
...
const Comfy_Window_UnloadConfirmation = { "name": "نمایش تأیید هنگام بستن پنجره" };
...
const Comfy_Workflow_ConfirmDelete = { "name": "نمایش تأیید هنگام حذف ورک‌فلو" };
const Comfy_Workflow_Persist = { "name": "حفظ وضعیت ورک‌فلو و بازیابی هنگام بارگذاری (مجدد) صفحه" };
const Comfy_Workflow_ShowMissingModelsWarning = { "name": "نمایش هشدار مدل‌های مفقود" };
const Comfy_Workflow_ShowMissingNodesWarning = { "name": "نمایش هشدار نودهای مفقود" };
const Comfy_Workflow_SortNodeIdOnSave = { "name": "مرتب‌سازی شناسه نودها هنگام ذخیره ورک‌فلو" };
const Comfy_Workflow_WarnBlueprintOverwrite = { "name": "نیاز به تأیید برای بازنویسی بلوپرینت ساب‌گراف موجود" };
...
const LiteGraph_ContextMenu_Scaling = { "name": "مقیاس‌بندی منوهای ترکیبی نود هنگام زوم" };
...
const LiteGraph_Node_TooltipDelay = { "name": "تأخیر نمایش راهنما" };
...
//# sourceMappingURL=settings-aWa4u4qN.js.map